const questions = [
  {
    question: 'Dự án đầu tư công về cấp thoát nước, xử lý rác thải và công trình hạ tầng kỹ thuật khác là dự án nhóm A có tổng mức đầu tư',
    options: [
  ...
  {
    question: 'Thẩm quyền thẩm định báo cáo nghiên cứu khả thi đầu tư xây dựng dự án đầu tư xây dựng và kinh doanh kết cấu hạ tầng khu công nghiệp là:',
    options: [
      'a. Ban quản lý Khu công nghiệp',
      'b. Trung tâm quản lý hạ tầng kỹ thuật đô thị của tỉnh.',
      'c. Cơ quan chuyên môn về xây dựng thuộc Ủy ban nhân dân cấp tỉnh',
      'd. Cơ quan chuyên môn về xây dựng thuộc Bộ quản lý công trình xây dựng chuyên ngành',
    ],
    correct: 3
  },
  {
    question: 'Thẩm quyền thẩm định báo cáo nghiên cứu khả thi đầu tư xây dựng dự án hạ tầng kỹ thuật đô thị sử dụng vốn vay ODA vốn nhà nước ngoài đầu tư công đối với dự án nhóm B, công trình hạ tầng kỹ thuật cấp II do Hội đồng nhân dân tỉnh phê duyệt chủ trương đầu tư dự án là:',
    options: [
      'a. Ban quản lý về công trình hạ tầng kỹ thuật đô thị của tỉnh',
      'b. Trung tâm quản lý hạ tầng kỹ thuật đô thị của tỉnh',
      'c. Cơ quan chuyên môn về xây dựng thuộc Ủy ban nhân dân cấp tỉnh',
      'd. Cơ quan chuyên môn về xây dựng thuộc Bộ quản lý công trình xây dựng chuyên ngành',
    ],
