const questions = [
  {
    question: 'Trách nhiệm phối hợp thực hiện khi xây dựng, cải tạo công trình điện lực và các công trình khác?',
    options: [
      ...
      'b. Khi tu sửa, cải tạo, xây dựng và lắp đặt trang thiết bị điện và công trình điện lực có khả năng ảnh hưởng đến công trình công cộng hoặc công trình khác thì đơn vị điện lực phải phối hợp với tổ chức, cá nhân có liên quan để giải quyết.',
      'c. Trường hợp các bên liên quan không thoả thuận được thì yêu cầu cơ quan nhà nước có thẩm quyền giải quyết và triển khai thực hiện theo quyết định của cơ quan nhà nước có thẩm quyền.',
      'd. Cả 3 nội dung trên',
    ],
    correct: 3
  },
  {
    question: 'Theo quy định của pháp luật hiện hành, lưới điện phân phối của Việt Nam có bao nhiêu cấp điện áp:',
    options: [
      'a. 6 cấp',
      'b. 7 cấp',
      'c. 9 cấp',
  ...
  {
    question: 'Theo quy định pháp luật về điện lực, anh chị hiểu thế nào là nơi thường xuyên tập trung đông người:',
    options: [
      'a. chợ, quảng trường, bệnh viện, trường học; nơi tổ chức hội chợ, triển lãm, trung tâm thương mại, khu vui chơi giải trí, bến tàu, bến xe, nhà ga và các công trình công cộng khác.',
      'b. chợ, quảng trường, bệnh viện, trường học; nơi tổ chức hội chợ, triển lãm, trung tâm thương mại, khu vui chơi giải trí, bến tàu, bến xe, nhà ga, đường giao thông có mật độ xe qua lại lớn.',
      'c. Là nơi thường xuyên tập trung đông người, phải tăng cường các biện pháp an toàn về điện và xây dựng.',
      'd. Đáp án a và',
    ],
    correct: 0
  },
  {
    question: 'Theo anh chị, hành vi nào sau đây đơn vị tư vấn chuyên ngành điện lực sẽ bị xử lý vi phạm hành chính:',
    options: [
      'a. Làm mất giấy phép hoạt động điện lực.',
      'b. Hoạt động tư vấn chuyên ngành điện lực không có giấy phép hoạt động điện lực.',
      'c. Không báo cáo định kỳ tình hình hoạt động trong lĩnh vực được cấp phép với cơ quan cấp giấy trước ngày cuối cùng của tháng đầu tiên năm tiếp theo.',
      'd. Tất cả các đáp án trên.',
    ],
    correct: 1
  },
  {
    question: 'Một trong các điều kiện để cấp giấy phép tư vấn thiết kế công trình đường dây và trạm biến áp là:',
    options: [
      'a. Chuyên gia tư vấn đảm nhận chức danh chủ nhiệm phải có bằng tốt nghiệp đại học trở lên chuyên ngành điện; có kinh nghiệm công tác ít nhất 05 năm trong lĩnh vực tư vấn; đã chủ nhiệm ít nhất 01 dự án hoặc tham gia thiết kế ít nhất 02 dự án công trình đường dây và trạm biến áp có hạng tương đương; có chứng chỉ hành nghề hoạt động xây dựng trong lĩnh vực thiết kế hạng tương đương.',
      'b. Chuyên gia tư vấn đảm nhận chức danh chủ nhiệm phải có bằng tốt nghiệp đại học trở lên chuyên ngành điện; đã chủ nhiệm ít nhất 01 dự án hoặc tham gia thiết kế ít nhất 02 dự án công trình đường dây và trạm biến áp có hạng tương đương; có chứng chỉ hành nghề hoạt động xây dựng trong lĩnh vực thiết kế hạng tương đương.',
      'c. Chuyên gia tư vấn khác phải có bằng tốt nghiệp đại học trở lên, có chứng chỉ hành nghề hoạt động xây dựng trong lĩnh vực thiết kế hạng tương đương.',
      'd. Điều kiện b và',
    ],
    correct: 0
  },
  ...
  },
  {
    ...
    options: [
      ...
      'd. Không thẩm định trường hợp nào ở trên',
    ],
    correct: 2
  },
  {
