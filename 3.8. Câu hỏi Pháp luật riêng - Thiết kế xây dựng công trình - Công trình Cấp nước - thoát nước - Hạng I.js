const questions = [
  {
    question: 'Lộ trình thực hiện mục tiêu phát triển bền vững Việt Nam đến năm 2030, tỷ lệ dân số đô thị được cung cấp nước sạch qua hệ thống cấp nước tập trung là:',
    options: [
      'a. 85 - 90%',
      'b. 90 - 95%',
      'c. 95 - 100%',
  ...
  {
    question: 'Lộ trình thực hiện mục tiêu phát triển bền vững Việt Nam đến năm 2030, tỷ lệ nước thải đô thị được thu gom, xử lý đạt tiêu chuẩn, quy chuẩn theo quy định đối với các đô thị loại 2 trở lên là:',
    options: [
      'a. 25 - 30%',
      'b. 30 - 35%',
      'c. 35 - 40%',
  ...
  {
    question: 'Lộ trình thực hiện mục tiêu phát triển bền vững Việt Nam đến năm 2030, tỷ lệ nước thải đô thị được thu gom, xử lý đạt tiêu chuẩn, quy chuẩn theo quy định đối với các đô thị loại 5 trở lên là:',
    options: [
      'a. 25 - 30%',
      'b. 30 - 35%',
      'c. 35 - 40%',
