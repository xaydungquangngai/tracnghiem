const questions = [
  {
    ...
    options: [
      'a. Luật Xây dựng; luật Đấu thầu.',
      'b. Luật Quy hoạch; luật Kiến trúc.',
      'c. Câu a và',
      'b. d. Câu a hoặc',
    ],
    correct: 2
  ...
  {
    question: 'Hành vi nào không bị nghiêm cấm trong hoạt động xây dựng:',
    options: [
      'a. Khởi công xây dựng công trình khi chưa đủ điều kiện khởi công theo quy định của pháp luật.',
      'b. Nhà thầu tham gia hoạt động xây dựng khi không đủ điều kiện năng lực để thực hiện hoạt động xây dựng.',
      'c. Xây dựng công trình tuân thủ tiêu chuẩn, quy chuẩn kỹ thuật được lựa chọn áp dụng cho công trình.',
      'd. Chủ đầu tư lựa chọn nhà thầu không đủ điều kiện năng lực để thực hiện hoạt động xây dựng.',
    ],
    correct: 2
  },
  {
    question: 'Căn cứ mức độ quan trọng và quy mô, dự án đầu tư xây dựng được phân loại:',
    options: [
      'a. Dự án quan trọng quốc gia, nhóm A, B và C.',
      'b. Dự án quan trọng quốc gia, nhóm A, B, C và D.',
      'c. Nhóm A, B và C.',
      'd. Nhóm A, B, C và D.',
    ],
    correct: 0
  ...
  {
    question: 'Theo pháp luật xây dựng, dự án đầu tư xây dựng được chia thành mấy các giai đoạn:',
    options: [
      'a. 3 giai đoạn, gồm giai đoạn chuẩn bị đầu tư; giai đoạn thực hiện đầu tư; giai đoạn kết thúc đầu tư.',
      'b. 3 giai đoạn, gồm giai đoạn chuẩn bị dự án; giai đoạn thực hiện dự án; giai đoạn kết thúc xây dựng.',
      'c. 4 giai đoạn, gồm giai đoạn gồm giai đoạn tiền dự án; giai đoạn chuẩn bị dự án; giai đoạn thực hiện dự án; giai đoạn kết thúc xây dựng.',
      'd. 4 giai đoạn, gồm giai đoạn tiền đầu tư; giai đoạn chuẩn bị đầu tư; giai đoạn thực hiện đầu tư; giai đoạn kết thúc đầu tư.',
    ],
    correct: 1
  },
  {
  ...
  {
    question: 'Cá nhân không yêu cầu phải có chứng chỉ hành nghề theo quy định khi thực hiện các hoạt động xây dựng nào sau đây?',
    options: [
  ...
  {
    question: 'Ai có thẩm quyền phê duyệt thiết kế biện pháp thi công?',
    options: [
      'a. Chủ đầu tư',
      'b. Nhà thầu thi công xây dựng',
