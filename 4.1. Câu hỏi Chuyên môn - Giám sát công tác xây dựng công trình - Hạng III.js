const questions = [
  {
    question: 'Cường độ bê tông tối thiểu để tháo dỡ cốp pha đà giáo chịu lực của kết cấu Bản, dầm, vòm có khẩu độ lớn hơn 8m (%R28) khi chưa chất tải là:',
    options: [
      'a. 50%.',
      'b. 70%.',
      'c. 80%.',
  ...
  {
    question: 'Nghiệm thu khối lượng công việc hoàn thành, căn cứ vào:',
    options: [
      'a. Hồ sơ thiết kế bản vẽ thi công, thiết kế điều chỉnh (nếu có); Bản vẽ hoàn công.',
      'b. Hồ sơ quản lý chất lượng vật liệu, sản phẩm, cấu kiện, thiết bị sử dụng cho công trình; Nhật ký thi công.',
      'c. Hợp đồng thi công xây dựng và các phụ lục hợp đồng.',
      'd. Bao gồm cả a, b và',
    ],
    correct: 3
  },
  {
    question: 'Mức sai lệch trục định vị chân cột trong thi công kết cấu bê tông và bê tông cốt thép lắp ghép cho phép (nếu trong thiết kế không quy định) là:',
    options: [
      'a. 10 mm.',
      'b. 5 mm.',
      'c. 15 mm.',
  ...
  {
    question: 'Công tác kiểm tra chất lượng thi công công tác đất thi công bằng cơ giới thủy lực bao gồm:',
    options: [
      ...
      'c. Tình trạng công trình và chất lượng đất bồi đắp Tình trạng công trình và chất lượng đất bồi đắp.',
      'd. Cả a, b và',
    ],
    correct: 3
  },
  {
    question: 'Sai số cao độ mặt dầm làm gối đỡ tấm sàn trong thi công kết cấu bê tông và bê tông cốt thép lắp ghép cho phép (nếu trong thiết kế không quy định) là:',
    options: [
      'a. -15 đến + 5 mm.',
      'b. -10 đến + 10 mm.',
      'c. -15 đến + 15 mm.',
