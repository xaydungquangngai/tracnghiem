const questions = [
  {
    question: 'Nội dung khảo sát mực nước ngầm trong hố khoan là gì?',
    options: [
  ...
  {
    question: 'Tài liệu gốc ĐCCT bao gồm: Hình trụ hố khoan đào; Tập ảnh đo vẽ ĐCCT; Nhật ký đo vẽ hiện trạng, đo vẽ ĐCCT; Kết quả thí nghiệm hiện trường và trong phòng; Các tài liệu khảo sát chuyên ngành: địa vật lý, động đất, tân kiến tạo, kết quả thí nghiệm cơ địa trong hầm ngang.',
    options: [
      'a. Đủ',
      'b. Thiếu',
  ...
  {
    question: 'Trong qua trình đánh giá động đất, kiến tạo và các hoạt động địa động lực hiện đại thì phải tiến hành điều tra và cung cấp các thông số về động đất, kiến tạo trên vùng nghiên cứu đối với công trình cấp mấy trở lên?',
    options: [
  ...
  {
    question: 'Trong thí nghiệm xác định độ chặt tiêu chuẩn trong phòng thí nghiệm, khi đầm nện lớp cuối cùng, mẫu đất sau khi đã được đầm đủ số búa thì được phép nhô cao hơn mép cối là bao nhiêu?',
    options: [
      'a. 0,3 cm.',
      'b. 0,5 cm.',
      'c. 1,0 cm.',
  ...
  {
    question: 'Khi thí nghiệm xác định sức chống cắt trong phòng thí nghiệm, để xác định sức chống cắt của đất, có bao nhiêu phương pháp (sơ đồ) chính?',
    options: [
      'a. 2.',
      'b. 3.',
      'c. 4.',
  ...
  {
    question: 'Trong quá trình khảo sát vùng các-tơ, sử dụng phương pháp do mặt cắt điện thì giới hạn xác định các đới xung yếu nằm ở độ sâu không lớn hơn bao nhiêu?',
    options: [
  ...
  {
    question: 'Bản đồ địa chất công trình tỷ lệ lớn bao gồm',
    options: [
  ...
  },
  {
    ...
    options: [
      'a. Thành phần, khối lượng công tác khảo sát; yêu cầu kỹ thuật cần thực hiện; giải pháp tổ chức thực hiện; tiến độ và giá thành dự kiến',
      ...
      'd. Quy định thành phần, khối lượng công tác khảo sát; yêu cầu kỹ thuật cần thực hiện; giải pháp tổ chức thực hiện; giá thành dự kiến',
    ],
    correct: 0
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      'c. Để phù hợp với đường kính của thiết bị thí nghiệm trong phòng, tránh làm hư hỏng phần xung quanh mẫu làm ảnh hưởng đến phần mẫu đất thí nghiệm bên trong',
      'd. Tránh làm hư hỏng phần xung quanh mẫu làm ảnh hưởng đến phần mẫu đất thí nghiệm bên trong, phù hợp với đường kính của thiết bị thí nghiệm trong phòng và đủ khối lượng mẫu để làm tất cả các chỉ tiêu thí nghiệm yêu cầu',
    ],
    correct: 3
  },
  {
    question: 'Tiêu chuẩn áp dụng thí nghiệm SPT',
    options: [
      'a. TCVN 9351: 2012',
      'b. TCVN 9352: 2012',
      'c. TCVN 9437: 2012',
  ...
  {
    question: 'Khi khoan khảo sát ĐCCT, các thí nghiệm nào sau đây có thể được tiến hành trong hố khoan?',
    options: [
      'a. Thí nghiệm nén tĩnh cọc, thí nghiệm SPT, thí nghiệm đổ nước, ép nước, thí nghiệm cắt cánh, thí nghiệm nén ngang',
      'b. Thí nghiệm nén tĩnh nền, thí nghiệm SPT, thí nghiệm đổ nước, ép nước, thí nghiệm cắt cánh, thí nghiệm nén ngang',
      'c. Thí nghiệm SPT, thí nghiệm đổ nước, ép nước, thí nghiệm cắt cánh, thí nghiệm nén ngang',
      'd. Thí nghiệm CPT, thí nghiệm SPT, thí nghiệm đổ nước, ép nước, thí nghiệm cắt cánh, thí nghiệm nén ngang.',
    ],
    correct: 2
  },
  {
    question: 'Theo tiêu chuẩn, mẫu nguyên dạng được lấy bởi dụng cụ gì?',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      'b. Xếp mẫu vào hòm phải chèn các khoảng trống giữa các mẫu bằng mùn cưa ẩm, vỏ bào hay vật liệu có tính chất tương tự sao cho chặt khít',
      'c. Xếp mẫu vào hòm phải chèn bằng mùn cưa ẩm, vỏ bào hay vật liệu có tính chất tương tự sao cho chặt khít. Mẫu đặt cách nhau 2-3 cm và cách thành hòm 3-4 cm, dưới mẫu để bảng thống kê mẫu, đánh số hòm, ghi địa chỉ người gửi, người nhận, đánh các ký hiệu và ghi chú cần thiết để bảo vệ hòm mẫu',
      'd. Xếp mẫu vào hòm phải chèn chặt. Mẫu đặt cách nhau 2-3 cm và cách thành hòm 3-4 cm, dưới mẫu để bảng thống kê mẫu, ghi địa chỉ người gửi, người nhận.',
    ],
    correct: 2
  },
  {
    ...
    options: [
      'a. Cho phép xác định được chính xác địa tầng, lấy được các loại mẫu thí nghiệm và tiến hành thí nghiệm trong hố khoan theo yêu cầu; đảm bảo yêu cầu kỹ thuật và an toàn lao động.',
      'b. Đạt tiến độ nhanh, năng suất khoan cao, chi phí vật tư thấp; đảm bảo yêu cầu kỹ thuật và an toàn lao động.',
      'c. Phát hiện chính xác địa tầng, lấy được các loại mẫu thí nghiệm và tiến hành thí nghiệm trong hố khoan theo yêu cầu; đạt năng suất khoan cao, hao phí vật tư ít và tiến độ nhanh; đảm bảo yêu cầu kỹ thuật và an toàn lao động.',
      'd. Cho phép xác định được chính xác địa tầng, lấy được các loại mẫu thí nghiệm và tiến hành thí nghiệm trong hố khoan theo yêu cầu.',
    ],
    correct: 2
  },
  {
