const questions = [
  {
    question: 'Đơn vị nào lập nhiệm vụ khảo sát xây dựng?',
    options: [
      'a. Chủ đầu tư;',
      'b. Nhà thầu khảo sát;',
      'c. Nhà thầu thiết kế;',
      'd. Nhà thầu thiết kế hoặc tổ chức, cá nhân có đủ điều kiện năng lực',
    ],
    correct: 3
  },
  {
    question: 'Giai đoạn thiết kế sau thiết kế cơ sở, chỉ dẫn kỹ thuật được phê duyệt cùng với phê duyệt thiết kế, dự toán hay phê duyệt riêng?',
    options: [
  ...
  {
    question: 'Trong khung tên từng bản vẽ thiết kế phải có tên, chữ ký của',
    options: [
      'a. Người vẽ, người trực tiếp thiết kế, người kiểm tra thiết kế, người chủ trì thiết kế, chủ nhiệm thiết kế, người đại diện theo pháp luật của nhà thầu thiết kế',
      'b. Người vẽ, người trực tiếp thiết kế, người kiểm tra thiết kế, người chủ trì thiết kế, chủ nhiệm thiết kế, giám đốc dự án, người đại diện theo pháp luật của nhà thầu thiết kế',
      'c. Người trực tiếp thiết kế, người kiểm tra thiết kế, người chủ trì thiết kế, chủ nhiệm thiết kế, người đại diện theo pháp luật của nhà thầu thiết kế.',
      'd. Người trực tiếp thiết kế, người kiểm tra thiết kế, người chủ trì thiết kế, chủ nhiệm thiết kế, giám đốc dự án, người đại diện theo pháp luật của nhà thầu thiết kế',
    ],
    correct: 2
  },
  {
    question: 'Dự án đầu tư xây dựng bệnh viện nhóm B sử dụng vốn khác, có công trình cấp cao nhất là cấp I thì phải trình cơ quan nào thẩm định báo cáo nghiên cứu khả thi?',
    options: [
  ...
  {
    question: 'Theo Quy chuẩn QCVN 01: 2021/BXD, chiều cao công trình xây dựng được tính như thế nào là đúng sau đây?',
    options: [
  ...
  {
    question: 'Danh mục tiêu chuẩn áp dụng cho dự án được phê duyệt bởi',
    options: [
      'a. Cơ quan chuyên môn về xây dựng',
      'b. Chủ đầu tư',
      'c. Tư vấn thiết kế',
      'd. Cơ quan chuyên môn của Chủ đầu tư',
    ],
    correct: 1
  },
  {
