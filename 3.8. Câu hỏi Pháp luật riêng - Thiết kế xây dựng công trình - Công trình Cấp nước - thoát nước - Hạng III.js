const questions = [
  {
    question: 'Diện tích đất xây dựng nhà máy cấp nước có công suất 8.000 m3/ngày đêm quy hoạch mới được xác định theo thông số diện tích tối thiểu khu đất là bao nhiêu.',
    options: [
      'a. 0,5 ha',
      'b. 01 ha',
      'c. 02 ha',
  ...
  {
    question: 'Dự án đầu tư công về cấp thoát nước, xử lý rác thải và công trình hạ tầng kỹ thuật khác là dự án nhóm C có tổng mức đầu tư',
    options: [
      'a. Dưới 120 tỷ đồng',
      'b. Dưới 80 tỷ đồng',
      'c. Dưới 60 tỷ đồng',
  ...
  {
    question: 'Quy chuẩn kỹ thuật quốc gia về Hệ thống công trình hạ tầng kỹ thuật',
    options: [
      'a. QCVN 01:2021/BXD',
      'b. QCVN 02:2022/BXD',
      'c. QCVN 06:2022/BXD',
