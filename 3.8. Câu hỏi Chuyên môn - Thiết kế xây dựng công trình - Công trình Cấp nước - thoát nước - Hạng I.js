const questions = [
  {
    question: 'Vùng phục vụ cấp nước:',
    options: [
      'a. Một đơn vị cấp nước chỉ được có một vùng phục vụ cấp nước, mỗi vùng phục vụ cấp nước chỉ do một đơn vị cấp nước thực hiện dịch vụ cấp nước',
      'b. Một đơn vị cấp nước có thể có nhiều vùng phục vụ cấp nước khác nhau, mỗi vùng phục vụ cấp nước có thể có nhiều đơn vị cấp nước thực hiện dịch vụ cấp nước',
      'c. Một đơn vị cấp nước có thể có một hoặc nhiều vùng phục vụ cấp nước khác nhau, mỗi vùng phục vụ cấp nước chỉ do một đơn vị cấp nước thực hiện dịch vụ cấp nước',
      'd. Một đơn vị cấp nước có thể có một hoặc nhiều vùng phục vụ cấp nước khác nhau, mỗi vùng phục vụ cấp nước có thể có nhiều đơn vị cấp nước thực hiện dịch vụ cấp nước',
    ],
    correct: 2
  },
  {
    question: 'Dự án đầu tư xây dựng tuyến ống cấp nước có đường kính trong 1000mm với tổng chiều dài tuyến ống là 3.100m, cấp công trình của tuyến ống cấp nước là cấp nào?',
    options: [
      'a. Cấp I',
      'b. Cấp II',
      'c. Cấp III',
  ...
  {
    question: 'Dự án đầu tư xây dựng tuyến cống nước thải, cống riêng có đường kính trong 1200mm với tổng chiều dài tuyến cống là 3.100m, cấp công trình của tuyến cống thoát nước là cấp nào?',
    options: [
      'a. Cấp I',
      'b. Cấp II',
      'c. Cấp III',
