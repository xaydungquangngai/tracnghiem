const questions = [
  ...
  {
    question: 'Hoạt động xem xét, đánh giá định kỳ khả năng chịu lực và các điều kiện để công trình được khai thác, sử dụng an toàn được gọi là gì?',
    options: [
      'a. Bảo trì công trình',
      'b. Đánh giá an toàn công trình',
      'c. Kiểm định xây dựng',
      'd. Thí nghiệm đối chứng',
    ],
    correct: 1
  },
  {
    question: 'Thời hạn sử dụng thực tế của công trình là gì?',
    options: [
      'a. Là khoảng thời gian công trình được dự kiến sử dụng, đảm bảo yêu cầu về công năng sử dụng.',
      'b. Là khoảng thời gian công trình được dự kiến sử dụng, đảm bảo yêu cầu về an toàn và công năng sử dụng.',
      'c. Là khoảng thời gian công trình được sử dụng thực tế, đảm bảo các yêu cầu về công năng sử dụng.',
      'd. Là khoảng thời gian công trình được sử dụng thực tế, đảm bảo các yêu cầu về an toàn và công năng sử dụng.',
    ],
    correct: 3
  },
  {
    question: 'Theo tính chất kết cấu, công trình được phân thành các loại nào:',
    options: [
      'a. Nhà kết cấu dạng nhà; trụ, tháp, bể chứa, silô, tường chắn, đê, đập, kè; kết cấu dạng đường ống;',
      'b. Nhà kết cấu dạng nhà; cầu, đường, hầm, cảng; kết cấu dạng đường ống;',
      'c. Nhà kết cấu dạng nhà; cầu, đường, hầm, cảng; trụ, tháp, bể chứa, silô, tường chắn, đê, đập, kè;',
      'd. Nhà kết cấu dạng nhà; cầu, đường, hầm, cảng; trụ, tháp, bể chứa, silô, tường chắn, đê, đập, kè; kết cấu dạng đường ống; các kết cấu khác',
    ],
    correct: 3
  },
  {
    question: 'Công trình Bảo tàng, thư viện, triển lãm, nhà trưng bày Quốc gia, theo mức độ quan trọng là công trình cấp mấy?',
    options: [
      'a. Cấp đặc biệt',
      'b. Cấp I',
      'c. Cấp II',
  ...
  {
    question: 'Công trình “Xây mới chùa A” có chiều cao 50m, sử dụng vật liệu kết hợp gỗ với BTCT, theo mức độ quan trọng là công trình cấp mấy?',
    options: [
      'a. Cấp đặc biệt',
      'b. Cấp I',
      'c. Cấp II',
  ...
  {
    question: 'Công trình “Xây dựng mới trụ sở Tòa án nhân dân cấp cao A”, theo mức độ quan trọng là công trình cấp mấy?',
    options: [
      'a. Cấp đặc biệt',
      'b. Cấp I',
      'c. Cấp II',
  ...
  {
    question: 'Ai được Thí nghiệm chuyên ngành xây dựng',
    options: [
      'a. Tổ chức',
      'b. Cá nhân',
      'c. Cả a và b',
      'd. Tổ chức, cá nhân có năng lực theo quy định',
    ],
    correct: 3
  },
  {
    question: 'Nhà thầu thi công xây dựng có trách nhiệm tổ chức thực hiện các hoạt động thí nghiệm chuyên ngành xây dựng, quan trắc, trắc đạc công trình trong quá trình thi công khi nào?',
    options: [
      'a. Theo nội dung Hợp đồng',
      'b. Theo yêu cầu của cơ quan Giám định',
      'c. Theo yêu cầu của Tiêu chuẩn, Quy chuẩn kỹ thuật có liên quan',
      'd. a và c',
    ],
    correct: 3
  },
  {
    question: 'Nội dung chi phí kiểm định xây dựng nào là đúng?',
    options: [
      'a. Chi phí kiểm định xây dựng phải được xác định bằng cách lập dự toán phù hợp với đề cương được duyệt.',
      'b. Chủ đầu tư chi trả chi phí kiểm định đối với các sản phẩm lỗi do đơn vị cung ứng sản phẩm đưa vào công trình.',
      'c. Chủ sở hữu hoặc người quản lý, sử dụng công trình có trách nhiệm chi trả toàn bộ chi phí thực hiện kiểm định trong quá trình khai thác, sử dụng trừ trường hợp có lỗi của tổ chức, các nhân khác.',
      'd. Chủ sở hữu hoặc người quản lý, sử dụng công trình có trách nhiệm chi trả chi phí thực hiện kiểm định trong quá trình khai thác, sử dụng. Trường hợp kết quả kiểm định chứng minh được lỗi thuộc trách nhiệm của tổ chức, cá nhân nào có liên quan thì các tổ chức, cá nhân đó phải chịu chi phí kiểm định tương ứng với lỗi do mình gây ra.',
    ],
    correct: 3
  },
  {
    question: 'Báo cáo kết quả kiểm định bao gồm các nội dung chính nào sau đây:',
    options: [
      'a. Căn cứ thực hiện kiểm định; Thông tin chung về công trình và đối tượng kiểm định; Nội dung, trình tự thực hiện kiểm định; Các kết quả thí nghiệm, quan trắc, tính toán, phân tích và đánh giá; Kết luận về nội dung kiểm định và kiến nghị.',
      'b. Thông tin chung về công trình và đối tượng kiểm định; Nội dung, trình tự thực hiện kiểm định; Các kết quả thí nghiệm, quan trắc, tính toán, phân tích và đánh giá.',
      'c. Căn cứ thực hiện kiểm định; Thông tin chung về công trình và đối tượng kiểm định; Các kết quả thí nghiệm, quan trắc, tính toán, phân tích và đánh giá.',
      'd. Căn cứ thực hiện kiểm định; Thông tin chung về công trình và đối tượng kiểm định; Nội dung, trình tự thực hiện kiểm định; Các kết quả thí nghiệm, quan trắc, tính toán, phân tích và đánh giá.',
    ],
    correct: 0
  },
  {
    question: 'Ai có trách nhiệm chi trả chi phí giám định xây dựng khi chưa có kết quả giám định?',
    options: [
  ...
  {
    question: 'Nội dung của Giám định xây dựng?',
    options: [
      'a. Giám định chất lượng khảo sát xây dựng, thiết kế xây dựng',
      'b. Giám định chất lượng vật liệu xây dựng, cấu kiện xây dựng, sản phẩm xây dựng, bộ phận công trình, công trình xây dựng',
      'c. Giám định nguyên nhân hư hỏng, sự cố công trình xây dựng',
      'd. Phương án a,b và c',
    ],
    correct: 3
  },
  {
    question: 'Trách nhiệm của từng thành viên liên danh được quy định cụ thể trong văn bản nào?',
    options: [
      'a. Hợp đồng thi công',
      'b. Thỏa thuận liên danh',
      'c. Hệ thống quản lý chất lượng của nhà thầu',
      'd. a và b',
    ],
    correct: 3
  },
  {
    question: 'Đối với dự án PPP, doanh nghiệp PPP được thực hiện trách nhiệm là:',
    options: [
      'a. Tư vấn giám sát',
  ...
  {
    question: 'Cơ quan nào tổ chức và xét duyệt giải thưởng chất lượng công trình xây dựng?',
    options: [
      'a. Bộ Giao thông vận tải',
      'b. Bộ Xây dựng',
      'c. Bộ Tài chính',
      'd. Bộ Khoa học công nghệ',
    ],
    correct: 1
  },
  {
    question: 'Nội dung quản lý thi công xây dựng công trình bao gồm:',
    options: [
      'a. Quản lý chất lượng, tiến độ, khối lượng, an toàn và môi trường trong thi công xây dựng công trình',
      'b. Quản lý chi phí, hợp đồng trong thi công xây dựng công trình',
      'c. Quản lý chất lượng và quản lý hợp đồng trong thi công xây dựng công trình',
      'd. Quản lý chất lượng, tiến độ, khối lượng, an toàn, môi trường, chi phí và hợp đồng trong thi công xây dựng công trình',
    ],
    correct: 3
  },
  {
  ...
  {
    question: 'Các nội dung sau, đâu là công việc thuộc trách nhiệm của Chủ đầu tư?',
    options: [
      'a. Phê duyệt danh mục Tiêu chuẩn áp dụng cho dự án',
      'b. Lập Chỉ dẫn kỹ thuật',
      'c. Phê duyệt biện pháp thi công',
      'd. Xác định vùng nguy hiểm trong thi công xây dựng công trình',
    ],
    correct: 2
  },
  {
    question: 'Xác định khối lượng thi công xây dựng trên cơ sở nào?',
    options: [
      'a. Hồ sơ thiết kế được duyệt',
      'b. Xác nhận giữa chủ đầu tư, nhà thầu thi công xây dựng, tư vấn giám sát theo thời gian hoặc giai đoạn thi công',
      'c. Nhật ký thi công',
      'd. a và b',
    ],
    correct: 3
  ...
  {
    question: 'Công trình nào phải được nhà nước có thẩm quyền kiểm tra công tác nghiệm thu trong quá trình thi công và khi hoàn thành thi công xây dựng công trình?',
    options: [
      'a. Công trình xây dựng thuộc dự án quan trọng quốc gia, công trình quy mô lớn, kỹ thuật phức tạp.',
      'b. Công trình sử dụng vốn đầu tư công',
      'c. Công trình có ảnh hưởng lớn đến an toàn, lợi ích cộng đồng',
      'd. Cả a, b và c',
    ],
    correct: 3
  },
  {
    question: 'Thẩm quyền kiểm tra công trình nằm trên địa bàn 02 tỉnh trở lên?',
    options: [
      'a. Cơ quan chuyên môn về xây dựng thuộc UBND cấp tỉnh',
      'b. Cơ quan chuyên môn về xây dựng thuộc Bộ quản lý công trình xây dựng chuyên ngành',
      'c. Hội đồng kiểm tra nhà nước về công tác nghiệm thu công trình xây dựng',
      'd. Cả a, b và c',
    ],
    correct: 1
  },
  {
    question: 'Thời gian tối thiểu lưu trữ hồ sơ là bao lâu đối với công trình nhóm A?',
    options: [
      'a. 5 năm',
      'b. 10 năm',
      'c. 15 năm',
  ...
  {
    question: 'Trách nhiệm về chất lượng công trình xây dựng sau thời gian bảo hành được quy định thế nào?',
    options: [
      'a. Chủ đầu tư chịu trách nhiệm',
      'b. Tư vấn giám sát chịu trách nhiệm',
      'c. Nhà thầu thi công xây dựng chịu trách nhiệm.',
      'd. Các nhà thầu chịu trách nhiệm về chất lượng đối với phần công việc do mình thực hiện.',
    ],
    correct: 3
  },
  {
    question: 'Nội dung, yêu cầu, trách nhiệm, hình thức, giá trị và thời hạn bảo hành công trình nhà ở được quy định thế nào?',
    options: [
      'a. Thực hiện theo pháp luật về xây dựng',
      'b. Thực hiện theo quy định tại Điều 29 Nghị định số 06/2021/NĐ-CP',
      'c. Thực hiện theo quy định của pháp luật về nhà ở',
      'd. Cả 3 đáp án trên',
    ],
    correct: 2
  },
  {
    question: 'Nội dung nào sau đây không thuộc nội dung chính của quy trình bảo trì công trình xây dựng',
    options: [
      'a. thông số kỹ thuật, công nghệ của công trình, bộ phận công trình và thiết bị công trình',
      'b. đối tượng, phương pháp và tần suất kiểm tra công trình;',
      'c. Tên các chủ thể tham gia xây dựng công trình',
      'd. Cả 3 đáp án trên',
    ],
    correct: 2
  },
  {
    question: 'Chủ thể nào có trách nhiệm lập và phê duyệt quy trình bảo trì trong trường hợp công trình xây dựng đã đưa vào khai thác, sử dụng nhưng chưa có quy trình bảo trì',
    options: [
      'a. Chủ đầu tư',
  ...
  {
    question: 'Kế hoạch bảo trì công trình xây dựng được lập theo tần suất nào?',
    options: [
      'a. Hàng tuần',
      'b. Hàng năm',
      'c. Hàng tháng',
  ...
  {
    question: 'Chủ thể nào thực hiện việc kiểm tra, bảo dưỡng và sửa chữa công trình',
    options: [
      'a. Chủ đầu tư',
      'b. Tổ chức, cá nhân cung cấp dịch vụ',
      'c. Cà 2 đáp án trên',
      'd. Chủ đầu tư được tự thực hiện nếu đủ điều kiện năng lực hoặc thuê tổ chức có đủ điều kiện năng lực thực hiện.',
    ],
    correct: 3
  },
  {
    question: 'Kiểm định chất lượng công trình phục vụ công tác bảo trì được thực hiện trong các trường hợp nào?',
    options: [
      'a. Kiểm định định kỳ theo quy trình bảo trì công trình đã được phê duyệt',
      'b. Khi có yêu cầu của cơ quan quản lý nhà nước có thẩm quyền',
      'c. phục vụ cho việc lập quy trình bảo trì đối với những công trình đã đưa vào sử dụng nhưng chưa có quy trình bảo trì',
      'd. cả 3 đáp án trên',
    ],
    correct: 3
  },
  {
    question: 'Trường hợp nào phải thực hiện Quan trắc công trình phục vụ công tác bảo trì',
    options: [
      'a. Các công trình quan trọng quốc gia',
  ...
  {
    question: 'Mức tiền bảo hành cho công tác sửa chữa được quy định thế nào?',
    options: [
      'a. không thấp hơn 5% giá trị hợp đồng',
      'b. không thấp hơn 10% giá trị hợp đồng',
      'c. không thấp hơn 3% giá trị hợp đồng',
      'd. Không có quy định',
    ],
    correct: 0
  },
  {
    question: 'Chi phí cho công tác bảo trì được hình thành từ các nguồn vốn nào:',
    options: [
      'a. vốn nhà nước ngoài đầu tư công',
      'b. vốn ngân sách nhà nước chi thường xuyên',
      'c. nguồn thu từ việc khai thác, sử dụng công trình xây dựng',
      'd. cả 3 đáp án trên',
    ],
    correct: 3
  },
  {
    question: 'Chủ thể nào được thực hiện đánh giá an toàn công trình',
    options: [
      'a. Chủ đầu tư',
      'b. Chủ sở hữu hoặc người quản lý, sử dụng công trình',
      'c. tổ chức kiểm định',
      'd. Chủ sở hữu hoặc người quản lý, sử dụng công trình nếu đủ điều kiện năng lực hoặc tổ chức kiểm định có đủ điều kiện năng lực',
    ],
    correct: 3
  },
  {
    question: 'Tổ chức đánh giá an toàn công trình có những trách nhiệm gì',
    options: [
      'a. Bảo hành, bảo trì công trình xây dựng',
      'b. Lập đề cương đánh giá an toàn công trình',
      'c. Thực hiện đánh giá an toàn công trình theo đề cương được phê duyệt',
      'd. Cả 2 đáp án b và c',
    ],
    correct: 3
  },
  {
    question: 'Chủ sở hữu hoặc người quản lý, sử dụng công trình phải thực hiện những gì để làm căn cứ xác nhận kết quả đánh giá an toàn công trình',
    options: [
      'a. kiểm tra khối lượng công việc đánh giá an toàn đã thực hiện',
      'b. xem xét sự phù hợp của báo cáo đánh giá an toàn công trình so với đề cương đánh giá an toàn công trình được phê duyệt và quy định của hợp đồng',
      'c. Kiểm tra nội dung so với quy trình bảo trì',
      'd. Cả 2 đáp án a và b',
    ],
    correct: 3
  },
  {
    question: 'Việc xác định thời hạn sử dụng của công trình được thực hiện trên cơ sở những tài liệu nào',
    options: [
      'a. hồ sơ thiết kế xây dựng công trình',
      'b. quy chuẩn kỹ thuật áp dụng cho công trình',
      'c. Tiêu chuẩn kỹ thuật áp dụng cho công trình',
      'd. Cả 3 đáp án trên',
    ],
    correct: 3
  },
  {
    question: 'Phương án, giải pháp phá dỡ công trình xây dựng bao gồm các nội dung chính nào',
    options: [
  ...
  {
    question: 'Đối với các sự cố có thiệt hại về người, Chủ đầu tư báo cáo cho đơn vị nào?',
    options: [
      'a. UBND cấp xã nơi xảy ra sự cố',
      'b. Cơ quan công an nơi xảy ra sự cố',
      'c. Bộ Xây dựng và cơ quan nhà nước có thẩm quyền theo quy định của pháp luật có liên quan',
      'd. UBND cấp tỉnh',
    ],
    correct: 2
  },
  {
    question: 'Cơ quan nào có trách nhiệm chủ trì giải quyết sự cố công trình xây dựng?',
    options: [
      'a. UBND cấp xã',
      'b. UBND cấp huyện',
      'c. UBND cấp tỉnh',
