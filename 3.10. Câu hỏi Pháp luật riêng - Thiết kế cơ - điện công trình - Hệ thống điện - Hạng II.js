const questions = [
  {
    question: 'Khi thiết kế, lắp đặt công trình điện lực, cần lưu ý quy định chung về an toàn đối với thiết bị điện và công trình điện lực gồm những nội dung nào?',
    options: [
      'a. Việc thiết kế, chế tạo thiết bị, xây dựng công trình điện lực phải thực hiện theo tiêu chuẩn, quy chuẩn kỹ thuật hoặc tiêu chuẩn nước ngoài, quốc tế được cơ quan nhà nước có thẩm quyền cho phép áp dụng tại Việt Nam.',
      'b. Phải đảm bảo các yêu cầu sau đây: An toàn về điện; An toàn về xây dựng; An toàn về công nghệ sử dụng nguồn năng lượng sơ cấp ;An toàn về phòng, chống cháy nổ; Các quy định về bảo vệ môi trường.',
      'c. Phải đảm bảo hành lang an toàn lưới điện cao áp.',
      'd. Nội dung a và',
    ],
    correct: 3
  },
  {
    question: 'Anh chị hiểu như thế nào là công trình điện lực?',
    options: [
      'a. Là là tổ hợp các phương tiện, máy móc, thiết bị, kết cấu xây dựng phục vụ trực tiếp cho hoạt động phát điện, truyền tải điện, phân phối điện; điều độ hệ thống điện, mua bán điện; Hệ thống bảo vệ công trình điện lực; hành lang bảo vệ an toàn lưới điện; đất sử dụng cho công trình điện lực và công trình phụ trợ khác.',
      'b. Là là tổ hợp các phương tiện, máy móc, thiết bị, kết cấu xây dựng phục vụ trực tiếp cho hoạt động phát điện, truyền tải điện, phân phối điện.',
      'c. Hệ thống bảo vệ công trình điện lực; hành lang bảo vệ an toàn lưới điện; đất sử dụng cho công trình điện lực và công trình phụ trợ khác.',
      'd. Nội dung b và',
    ],
    correct: 0
  },
  {
    question: 'Quy định về bảo vệ an toàn trạm điện gồm những nội dung nào?',
    options: [
      'a. Không được xây dựng nhà ở, công trình và trồng các loại cây cao hơn 2 mét trong hành lang bảo vệ an toàn trạm điện; không xâm phạm đường ra vào của trạm;',
      'b. Nhà ở, công trình xây dựng gần hành lang bảo vệ của trạm điện phải bảo đảm không làm hư hỏng bất kỳ bộ phận nào của trạm.',
      'c. Cả nội dung a và',
      'b.',
      'd. Chỉ nội dung',
    ],
  ...
  {
    question: 'Khoảng cách an toàn phóng điện theo cấp điện áp quy định tại khoản 4 Điều 51 Luật điện lực là khoảng cách tối thiểu từ dây dẫn điện đến điểm gần nhất của thiết bị, dụng cụ, phương tiện làm việc trong hành lang bảo vệ an toàn lưới điện cao áp phải đáp ứng như thế nào sau đây:',
    options: [
      'a. Đến 6m đối với cấp điện áp 110kV.',
      'b. Đến 6m đối với cấp điện áp 220kV.',
      'c. Đến 4m đối với cấp điện áp 35kV.',
      'd. Đáp án a, b và c đều đúng.',
    ],
    correct: 3
  },
  {
    question: 'Trách nhiệm phối hợp thực hiện khi xây dựng, cải tạo công trình điện lực và các công trình khác bao gồm những nội dung nào:',
    options: [
      'a. Khi xây dựng, cải tạo và mở rộng công trình công cộng hoặc công trình khác có khả năng ảnh hưởng đến an toàn của trang thiết bị điện, công trình điện lực và an toàn điện, chủ đầu tư phải phối hợp với đơn vị điện lực để giải quyết.',
      'b. Tổ chức, cá nhân có trách nhiệm thông báo kịp thời với đơn vị điện lực hoặc cơ quan nhà nước có thẩm quyền khi phát hiện các hiện tượng mất an toàn điện, các hành vi vi phạm quy định về bảo vệ trang thiết bị điện, công trình điện lực và an toàn điện.',
      'c. Khi tu sửa, cải tạo, xây dựng và lắp đặt trang thiết bị điện và công trình điện lực có khả năng ảnh hưởng đến công trình công cộng hoặc công trình khác thì đơn vị điện lực phải phối hợp với tổ chức, cá nhân có liên quan để giải quyết.',
      'd. Nội dung a và',
    ],
    correct: 3
  },
