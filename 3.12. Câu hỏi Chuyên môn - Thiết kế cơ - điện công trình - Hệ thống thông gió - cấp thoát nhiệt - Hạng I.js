const questions = [
  ...
  {
    question: 'Mục đích sử dụng biểu đồ l-d trong tính toán thiết kế hệ thống thông gió và điều hòa không khí là gì ?',
    options: [
  ...
  {
    question: 'Tiêu chuẩn Việt Nam TCVN 5687:2024 được áp dụng khi thiết kế là lắp đặt các hệ thống thông gió - điều hòa không khí cho đối tượng nào ?',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      'b. Hơi tác nhân lạnh ngưng tụ ở 40oC trong bộ trao đổi nhiệt được làm mát bằng không khí;',
  ...
  {
    question: 'Thông số tính toán của không khí ngoài trời dùng để thiết kế Điều hòa không khí theocấp III có số giờ cho phép không đảm bảo chế độ nhiệt ẩm bên trong nhàlà bao nhiêu ?',
    options: [
      'a. m = 250 - 300 h/năm;',
      'b. m = 300 - 350 h/năm;',
      'c. m = 350 - 400 h/năm;',
  ...
  {
    question: 'Mục đích sử dụng biểu đồ I-d trong tính toàn thiết kế hệ thống thông gió và điều hòa không khí là gì ?',
    options: [
      'a. Biểu diễn sự thay đổi nhiệt độ khí truyền qua tường;',
      'b. Tính toán nhu cầu nhiệt ẩn;',
  ...
  },
  {
    ...
    options: [
      ...
      'd. Văn phòng, khạch sạn, bệnh viện, trường học, thương mại, dịch vụ, chung cư',
    ],
    correct: 3
  },
  {
  ...
  {
    question: 'Thông số tính toán của không khí trong phòng dùng để thiết kế điều hòa không khí về mùa đông có nhiệt độ từ 21 - 23(oC), độ ẩm tương đối từ 60 - 70 (%), vận tốc gió từ 0,4 - 0,5 (m/s) tương ứng với trạng thái lao động nào dưới đây ?',
    options: [
