const questions = [
  ...
  {
    question: 'Trong bảo vệ chống sét trực tiếp, khoảng cách phóng điện ds (bán kính quả cầu lăn) đối với bảo vệ cấp II là:',
    options: [
      'a. 20 m',
      'b. 30 m',
      'c. 45 m',
  ...
  {
    question: 'Hệ số đồng thời trong nhà tập thể, chung cư có từ 15 đến 19 căn hộ là bao nhiêu?',
    options: [
      'a. 0,78',
      'b. 0,63',
      'c. 0,53',
  ...
  {
    question: 'Hệ số đồng thời của tủ phân phối có số mạch 4 và 5 là bao nhiêu?',
    options: [
      'a. 0,9',
      'b. 0,8',
      'c. 0,7',
  ...
  {
    question: 'Trong bảo vệ chống sét công trình cấp IV bằng lồng thu sét, kích thước của lưới thu sét trên mái bằng bao nhiêu?',
    options: [
      'a. 5m x 5m',
      'b. 10m x 10m',
      'c. 15m x 15m',
  ...
  {
    question: 'Khi xác định vị trí của hệ thống đầu thu sét bằng phương pháp góc bảo vệ, góc bảo vệ cấp I của đối tượng được bảo vệ có cao trên 16 m phải nhỏ hơn bao nhiêu?',
    options: [
      'a. 30 độ',
      'b. 40 độ',
      'c. 45 độ',
  ...
  {
    question: 'Tiết diện nhỏ nhất của dây thu sét bằng đồng là bao nhiêu?',
    options: [
      'a. 35 mm2',
      'b. 50 mm2',
      'c. 70 mm2',
  ...
  {
    question: 'Tiết diện nhỏ nhất của dây dẫn bằng đồng nối các thanh liên kết khác nhau hoặc nối các thanh liên kết với hệ thống đầu tiếp đất là bao nhiêu?',
    options: [
      'a. 16 mm2',
      'b. 35 mm2',
      'c. 50 mm2',
  ...
  {
    question: 'Thiết bị điện có được phép đặt trong vùng nguy hiểm (vùng có thể tồn tại khí cháy nổ) không?',
    options: [
      'a. Không được phép đặt bất kỳ thiết bị điện nào',
      'b. Có thể đặt thiết bị điện vào vùng nguy hiểm kể cả zone 0',
      'c. Chỉ được phép đặt thiết bị điện trong zone 1',
      'd. Chỉ có thể đặt thiết bị điện có chứng chỉ chống cháy nổ',
    ],
    correct: 3
  },
  {
    question: 'Hộ tiêu thụ điện được phân chia thành mấy loại?',
    options: [
      'a. 2',
      'b. 3',
      'c. 4',
  ...
  {
    question: 'Theo tiêu chuẩn TCVN 9206, hệ số công suất cosꝕ của thang máy trong nhà khách, khách sạn là bao nhiêu?',
    options: [
      'a. 0,5',
      'b. 0,6',
      'c. 0,7',
  ...
  {
    question: 'Phương pháp tính toán phụ tải điện theo điều kiện tổn thất điện áp cho phép được áp dụng trong trường hợp nào:',
    options: [
      'a. Lưới điện phân phối điện áp từ 1 đến 22kV.',
      'b. Lưới điện phân phối điện áp đến 1kV.',
  ...
  {
    question: 'Cá nhân có trình độ cao đẳng, trung cấp có chứng chỉ hành nghề thiết kế được chủ trì thiết kế công trình điện lực cấp mấy?',
    options: [
      'a. Cấp II trở xuống',
      'b. Cấp III trở xuống',
      'c. Cấp IV',
  ...
  {
    question: 'Trang bị phân phối và trạm biến áp trọn bộ ngoài trời, trạm GIS ngoài trời phải đáp ứng những yêu cầu nào:',
    options: [
      'a. Bố trí cao hơn mặt bằng ít nhất 0,5m và phải có chỗ để thao tác; đảm bảo sự làm mát của thiết bị.',
      'b. Bố trí cao hơn mặt bằng ít nhất 0,3m và phải có chỗ để thao tác; Có thể kéo ra và vận chuyển máy biến áp, thiết bị GIS, xe đẩy của tủ trọn bộ; đảm bảo sự làm mát của thiết bị.',
      'c. Có thể kéo ra và vận chuyển máy biến áp, thiết bị GIS, xe đẩy của tủ trọn bộ; đảm bảo sự làm mát của thiết bị.',
      'd. Đảm bảo nội dung a và',
    ],
    correct: 1
  },
  {
    question: 'Bảo vệ chống sét cho trang bị phân phối và trạm biến áp ngoài trời thực hiện như thế nào?',
    options: [
      'a. Trạm biến áp và trang bị phân phối ngoài trời 22-500kV phải được bảo vệ chống sét đánh trực tiếp.',
      'b. Không cần bảo vệ chống sét đánh trực tiếp đối với trạm biến áp hợp bộ, trạm biến áp có vỏ bằng thép điện áp đến 35kV.',
      'c. Không cần bảo vệ chống sét đánh trực tiếp đối với trạm biến áp điện áp 22-35kV có máy biến áp công suất mỗi máy đến 1600KVA.',
