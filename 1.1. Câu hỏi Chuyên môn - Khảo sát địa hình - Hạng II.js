const questions = [
  {
    question: 'Khi thi công nhà cao tầng, sai số về độ cao của kết cấu bê tông cốt thép loại khung, vách đổ tại chỗ ở mỗi tầng không vượt quá:',
    options: [
      'a. ± 05mm;',
      'b. ± 10mm;',
      'c. ± 15mm;',
  ...
  {
    question: 'Khi thi công cọc đóng, bố trí cọc một hàng cho loại cọc có cạnh đến 0.5m. Độ lệch mặt bằng so với thiết kế không vượt quá:',
    options: [
      'a. 0.2D;',
      'b. 0.25D;',
      'c. 0.3D;',
  ...
  {
    question: 'Khi thi công nhà cao tầng, sai số bố trí đường trục đứng tại mỗi tầng không vượt quá:',
    options: [
      'a. ± 03mm;',
      'b. ± 05mm;',
      'c. ± 10mm;',
  ...
  {
    question: 'Khi thi công cọc đóng, bố trí cọc đơn dưới cột cho loại cọc tròn rỗng có đường kính từ 0.5m đến 0.8m. Độ lệch của tim cọc về mặt bằng so với thiết kế không vượt quá:',
    options: [
      'a. 08cm;',
      'b. 10cm;',
      'c. 15cm',
  ...
  {
    question: 'Cấp chính xác bố trí công trình cấp 2 có đặc trưng độ chính xác như thế nào:',
    options: [
  ...
  {
    question: 'Sai số cho phép đo độ nghiêng của nhà cao tầng không vượt quá:',
    options: [
      'a. 0.00001 x H',
      'b. 0.0001 x H',
      'c. 0.0005 x H',
  ...
  {
    question: 'Để đo độ lún công trình bằng phương pháp đo cao hình học cấp 2 cần sử dụng các máy thủy chuẩn có độ phóng đại đạt:',
    options: [
      'a. 40 lần',
      'b. từ 35 đến 40 lần',
      'c. 16 lần',
  ...
  {
    question: 'Đo độ lún của nền móng các nhà và công trình được xây dựng trên nền đất cát, đất sét và trên nền đất có tính biến dạng cao phải chọn cấp độ đo lún nào?',
    options: [
      'a. Cấp I',
      'b. Cấp II',
      'c. Cấp III',
  ...
  {
    question: 'Đo độ lún công trình bằng phương pháp đo cao hình học ở cấp nào thì chiều cao của tia ngắm phải cách mặt đất tối thiểu 0.5m:',
    options: [
      'a. I',
      'b. ll',
      'c. Ill',
  ...
  },
  {
    ...
    options: [
      ...
      'b. 0.15 mm trên bản đồ đối với vùng quang đãn',
