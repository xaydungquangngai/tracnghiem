const questions = [
  ...
  {
    question: 'Căn cứ nguồn vốn sử dụng và hình thức đầu tư, theo quy định của pháp luật xây dựng Việt Nam, dự án đầu tư xây dựng được phân thành mấy loại dự án?',
    options: [
  ...
  {
    question: 'Quy hoạch đô thị áp dụng cho các khu vực nào sau đây?',
    options: [
  ...
  {
    question: 'Quy hoạch phân khu thường được lập cho phạm vi nào?',
    options: [
  ...
  {
    question: 'Quy hoạch chung được lập cho những khu chức năng nào?',
    options: [
