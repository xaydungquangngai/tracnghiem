const questions = [
  ...
  {
    question: 'Theo quy định của pháp luật Xây dựng hiện hành, nhà thầu nào có trách nhiệm lập biện pháp an toàn cho người và thiết bị thi công công trình trên công\ntrường xây dựng?',
    options: [
      'a. Nhà thầu thiết kế',
