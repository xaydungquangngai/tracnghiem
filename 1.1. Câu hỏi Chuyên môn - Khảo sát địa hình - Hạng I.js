const questions = [
  {
    question: 'Áp dụng phương pháp giao hội thuận để quan trắc chuyển dịch ngang công trình, phải giao hội tối thiểu từ mấy điểm?',
    options: [
      'a. 02 điểm;',
      'b. 03 điểm;',
      'c. 04 điểm;',
  ...
  {
    question: 'Sai số giới hạn đo độ nghiêng các Silo chứa vật liệu rời, Bồn chứa dầu, khí hóa lỏng không vượt quá:',
    options: [
      'a. 0,0001 x H;',
      'b. 0,00001 x H;',
      'c. 0,0005 x H;',
  ...
  {
    question: 'Khi thi công nhà cao tầng, sai số về cao độ của kết cấu bê tông cốt thép cho toàn chiều cao công trình không vượt quá:',
    options: [
      'a. ± 15mm;',
      'b. ± 20mm;',
      'c. ± 25mm;',
  ...
  {
    question: 'Khi thi công nhà cao tầng, sai số bố trí các đường trục chi tiết về mặt bằng trên một tầng thi công không vượt quá:',
    options: [
      'a. ± 03mm;',
      'b. ± 05mm;',
      'c. ± 10mm;',
  ...
  {
    question: 'Cấp chính xác bố trí công trình cấp 1 có đặc trưng độ chính xác như thế nào:',
    options: [
  ...
  {
    question: 'Loại công trình nào khi lập lưới khống chế thi công yêu cầu độ chính xác: mβ = 3", ms/s = 1/25000, mh = 4 mm/km?',
    options: [
  ...
  {
    question: 'Để đo độ lún công trình bằng phương pháp đo cao hình học cấp 1 cần sử dụng các máy thủy chuẩn có độ phóng đại không nhỏ hơn:',
    options: [
      'a. 40 lần',
      'b. 24 lần',
      'c. 16 lần',
  ...
  {
    question: 'Sai số cho phép đo độ nghiêng của ống khói, tháp cột cao không vượt quá: (H là độ cao công trình)',
    options: [
      'a. 0.00001 x H',
      'b. 0.0001 x H',
      'c. 0.0005 x H',
  ...
  },
  {
    ...
    options: [
      'a. Xí nghiệp, các cụm nhà và công trình xây dựng công trình trên phạm vi lớn hơn 100 ha, từng ngôi nhà và công trình riêng biệt trên diện tích lớn hơn 10 ha.',
      'b. Xí nghiệp, các cụm nhà và công trình xây dựng trên phạm vi nhỏ hơn 100 ha, từng ngôi nhà và công trình riêng biệt trên diện tích từ 1 ha đến 10 ha.',
      'c. Nhà và công trình xây dựng trên diện tích nhỏ hơn 1 ha, đường trên mặt đất và các đường ống ngầm trong phạm vi xây dựng.',
      'd. Đường trên mặt đất và các đường ống ngầm ngoài phạm vi xây dựng.',
    ],
