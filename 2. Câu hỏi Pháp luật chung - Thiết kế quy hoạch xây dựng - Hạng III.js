const questions = [
  ...
  {
    question: 'Cơ quan quyền lực cao nhất của nước CHXHCN Việt Nam là cơ quan nào?',
    options: [
  ...
  {
    question: 'Hệ thống văn bản pháp luật xây dựng hiện hành của nước Cộng hòa xã hội chủ nghĩa Việt Nam quy định chứng chỉ hành nghề hoạt động xây dựng có hiệu lực tối đa trong thời hạn bao nhiêu năm?',
    options: [
      'a. 5 năm',
      'b. 7 năm',
      'c. 3 năm',
  ...
  {
    question: 'Khái niệm về trách nhiệm trong lĩnh vực xây dựng của cơ quan quản lý nhà nước nào sau đây không đúng?',
    options: [
  ...
  {
    question: 'Đô thị được định nghĩa như thế nào theo Luật Quy hoạch đô thị và nông thôn?',
    options: [
      'a. Nơi sinh sống của cộng đồng dân cư chủ yếu hoạt động trong lĩnh vực nông nghiệp',
      'b. Nơi tập trung dân cư sinh sống có mật độ cao và chủ yếu hoạt động trong lĩnh vực phi nông nghiệp; là trung tâm chính trị, hành chính, kinh tế, văn hóa hoặc chuyên ngành, có vai trò thúc đẩy phát triển kinh tế - xã hội của quốc gia hoặc một vùng lãnh thổ',
      'c. Một khu vực chức năng trong đô thị, bao gồm các công trình hạ tầng xã hội',
      'd. Nơi sinh sống của cộng đồng dân cư với mật độ thấp, chủ yếu hoạt động trong lĩnh vực lâm nghiệp.',
    ],
    correct: 1
  },
  {
    question: 'Khu dân cư nông thôn được định nghĩa như thế nào theo Luật Quy hoạch đô thị và nông thôn?',
    options: [
      'a. Là nơi tập trung sinh sống của các hộ gia đình chủ yếu hoạt động trong lĩnh vực phi nông nghiệp',
      'b. Là nơi cư trú tập trung của các hộ gia đình gắn kết với nhau trong sản xuất, sinh hoạt và các hoạt động xã hội khác trong phạm vi một khu vực nhất định ở nông thôn, được hình thành do điều kiện tự nhiên, kinh tế - xã hội và hạ tầng kỹ thuật',
      'c. Là nơi sinh sống của cộng đồng dân cư chủ yếu hoạt động trong lĩnh vực công nghiệp',
      'd. Là một khu chức năng thuộc phạm vi đô thị',
    ],
    correct: 1
  },
  {
    question: 'Không gian đô thị, nông thôn được định nghĩa như thế nào theo Luật Quy hoạch đô thị và nông thôn?',
    options: [
      'a. Không gian trên mặt đất tại các khu đô thị và khu vực nông thôn',
      'b. Không gian trên mặt đất và dưới mặt đất tại các đô thị, nông thôn, không bao gồm không gian dưới nước',
      'c. Không gian trên mặt đất, dưới mặt đất, dưới nước tại đô thị, nông thôn',
      'd. Không gian xây dựng các công trình hạ tầng kỹ thuật và xã hội tại đô thị',
    ],
    correct: 2
  },
  {
    question: 'Chỉ tiêu kinh tế - kỹ thuật trong quy hoạch được định nghĩa như thế nào?',
    options: [
      'a. Là các chỉ tiêu được xác định để phát triển kinh tế, không liên quan đến kỹ thuật',
      'b. Là các chỉ tiêu được dự báo, xác định, lựa chọn trong quy hoạch làm cơ sở đề xuất các phương án, giải pháp quy hoạch gồm quy mô dân số, lao động, quy mô đất đai, các chỉ tiêu về hạ tầng kỹ thuật, hạ tầng xã hội và môi trường',
      'c. Là các chỉ tiêu dự kiến phát triển hạ tầng kỹ thuật và kinh tế mà không phụ thuộc vào các yếu tố xã hội',
      'd. Là các chỉ tiêu tập trung vào quy mô dân số và quy mô đất đai',
    ],
    correct: 1
  },
];
