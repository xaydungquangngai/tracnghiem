const questions = [
  {
    question: 'Xác định khối lượng nước thải sinh hoạt để tính giá dịch vụ thoát nước đối với các hộ thoát nước sử dụng nước sạch từ hệ thống cấp nước tập trung được tính bằng:',
    options: [
      'a. 70% khối lượng nước sạch tiêu thụ theo hóa đơn tiền nước',
      'b. 80% khối lượng nước sạch tiêu thụ theo hóa đơn tiền nước',
      'c. 90% khối lượng nước sạch tiêu thụ theo hóa đơn tiền nước',
      'd. 100% khối lượng nước sạch tiêu thụ theo hóa đơn tiền nước',
    ],
    correct: 1
  },
  {
    question: 'Giải pháp xử lý nước thải phi tập trung tại chỗ đối với các hộ thoát nước riêng lẻ với tổng lượng nước thải dưới:',
    options: [
      'a. 50m3/ngày.đêm',
      'b. 100m3/ngày.đêm',
      'c. 200m3/ngày.đêm',
  ...
  {
    question: 'Nhà máy nước, công trình xử lý nước sạch (bao gồm cả công trình xử lý bùn cặn) phân cấp công trình là cấp I có tổng công suất:',
    options: [
