const questions = [
  {
    question: 'Giới hạn cho phép của hệ thống cấp nước có bậc tin cậy là bậc 2 là:',
    options: [
      'a. Được phép ngừng cấp nước trong 12h',
      'b. Được giảm lưu lượng nước cấp so với lưu lượng nước tính toán không quá 30% trong vòng 6 ngày',
      'c. Được phép giảm lưu lượng nước cấp không quá 30% so với lưu lượng nước tính toán trong 10 ngày và ngừng cấp nước trong 6h.',
  ...
  {
    question: 'Khi sử dụng nguồn nước mặt cho hệ thống cấp nước, trường hợp không cần điều hoà dòng chảy để cân đối:',
    options: [
  ...
  {
    question: 'Bố trí các công trình thoát nước và điểm xả nước mưa, không được xả trực tiếp vào?',
    options: [
  ...
  {
    question: 'Trường hợp nhu cầu dùng nước vượt quá lưu lượng của nguồn nước, giải pháp có thể áp dụng?',
    options: [
      'a. Điều hoà dòng chảy bằng hồ chứa.',
      'b. Xây dựng hồ chứa điều chỉnh theo mùa khi nhu cầu lấy nước nhỏ hơn hoặc bằng lưu lượng của năm xảy ra kiệt ứng với tần suất tính toán kể cả lưu lượng nước mất đi ở hồ chứa.',
      'c. Xây dựng hồ chứa điều chỉnh dòng chảy nhiều năm khi nhu cầu lấy nước hàng năm vượt quá lưu lượng nước của năm xảy ra kiệt ứng với tần suất tính toán nhưng nhỏ hơn lưu lượng của dòng chảy trung bình nhiều năm.',
      'd. Gồm cả 3 đáp án a,b,',
    ],
    correct: 1
  },
  ...
  {
    question: 'Khi thiết kế giếng khai thác nước dưới đất, chiều sâu giếng phụ thuộc vào:',
    options: [
      'a. Độ sâu địa tầng',
  ...
  {
    question: 'Khi đặt bơm có động cơ trên miệng giếng (bơm giếng trục đứng); hoặc nếu dùng máy bơm chìm thì đường kính khai thác của ống vách phải lớn hơn đường kính qui ước của máy bơm ít nhất là:',
    options: [
      'a. 30 mm.',
      'b. 40 mm.',
      'c. 50 mm.',
