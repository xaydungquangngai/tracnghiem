const questions = [
  ...
  {
    question: 'Chủ đầu tư có trách nhiệm về quản lý an toàn lao động trong quá trình thi công xây dựng?',
    options: [
  ...
  {
    question: 'Chủ đầu tư không có nghĩa vụ gì trong quá trình thi công xây dựng công trình?',
    options: [
  ...
  {
    question: 'Hãy cho biết Thẩm quyền thẩm định Báo cáo nghiên cứu khả thi Dự án đầu tư xây dựng sử dụng nguồn vốn khác, có một công trình cấp II và thuộc danh mục công trình ảnh hưởng lớn đến an toàn, lợi ích cộng đồng?',
    options: [
  ...
  {
    question: 'Thẩm quyền thẩm định thiết kế triển khai sau thiết kế cơ sở đối với Dự án đầu tư có công trình cấp đặc biệt, cấp I sử dụng vốn nhà nước ngoài đầu tư công thuộc về:',
    options: [
  ...
  {
    question: 'Tổ chức nào có trách nhiệm lắp đặt biển báo công trình tại công trường?',
    options: [
