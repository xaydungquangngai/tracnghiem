const questions = [
  {
    question: 'Căn cứ quy định Điều 4 Nghị định 15/2021/NĐ-CP, trình tự nào sau đây là đúng trong giai đoạn chuẩn bị dự án?',
    options: [
      'a. Trình tự gồm: 1. Khảo sát xây dựng; 2. Lập thẩm định báo cáo nghiên cứu tiền khả thi, quyết định hoặc chấp thuận chủ trương đầu tư; 3. Lập thẩm định báo cáo nghiên cứu khả thi để phê duyệt đầu tư xây dựng; 4. Lập, thẩm định, phê duyệt quy hoạch chi tiết xây dựng phục vụ lập báo cáo nghiên cứu kha thi đầu tư xây dựng;',
      'b. Trình tự gồm: 1. Khảo sát xây dựng; 2. Lập thẩm định báo cáo nghiên cứu tiền khả thi, quyết định hoặc chấp thuận chủ trương đầu tư; 3. Lập, thẩm định, phê duyệt quy hoạch chi tiết xây dựng phục vụ lập báo cáo nghiên cứu kha thi đầu tư xây dựng; 4. Lập thẩm định báo cáo nghiên cứu khả thi để phê duyệt đầu tư xây dựng.',
      'c. Trình tự gồm: 1. Khảo sát xây dựng; 2. Lập thẩm định báo cáo nghiên cứu khả thi để phê duyệt đầu tư xây dựng; 3. Lập thẩm định báo cáo nghiên cứu tiền khả thi, quyết định hoặc chấp thuận chủ trương đầu tư; 4. Lập, thẩm định, phê duyệt quy hoạch chi tiết xây dựng phục vụ lập báo cáo nghiên cứu kha thi đầu tư xây dựng;',
      'd. Trình tự gồm: 1. Khảo sát xây dựng; 2. Lập, thẩm định, phê duyệt quy hoạch chi tiết xây dựng phục vụ lập báo cáo nghiên cứu khả thi đầu tư xây dựng; 3. Lập thẩm định báo cáo nghiên cứu tiền khả thi, quyết định hoặc chấp thuận chủ trương đầu tư; 4. Lập thẩm định báo cáo nghiên cứu khả thi để phê duyệt đầu tư xây dựng',
    ],
    correct: 1
  },
  {
    question: 'Thiết kế sơ bộ của Báo cáo Nghiên cứu tiền khả thi đầu tư dự án được thể hiện thông qua nội dung nào sau đây?',
    options: [
      'a. Bản vẽ thiết kế sơ bộ gồm: Sơ đồ vị trí, địa điểm khu đất xây dựng; sơ bộ mặt bằng của dự án; thể hiện giải pháp thiết kế sơ bộ công trình chính của dự án.',
      'b. Thuyết minh gồm: quy mô, tính chất của dự án; hiện trạng, ranh giới khu đất; thuyết minh về sự phù hợp với quy hoạch, kết nối giao thông, hạ tầng kỹ thuật dự án; thuyết minh về giải pháp thiết kế sơ bộ.',
  ...
  {
    question: 'Trong trường hợp nào dự án phải lập báo cáo nghiên cứu tiền khả thi?',
    options: [
      'a. Dự án trọng điểm quốc gia, dự án nhóm A sử dụng vốn đầu tư công.',
      'b. Dự án nhóm B sử dụng vốn đầu tư công.',
      'c. Dự án thuộc cấp công trình cấp I.',
      'd. Dự án thuộc cấp công trình cấp II trở lên.',
    ],
    correct: 0
  },
  {
    question: 'Trường hợp nào sau đây khi điều chỉnh thiết kế phải trình cơ quan chuyên môn về xây dựng thẩm định lại?',
    options: [
      'a. Thay đổi kết cấu chịu lực công trình.',
      'b. Thay đổi vật liệu sử dụng cho công trình.',
      'c. Thay đổi biện pháp tổ chức thi công.',
      'd. Gồm cả 3 trường hợp a, b và',
    ],
    correct: 0
  },
  {
  ...
  {
    question: 'Các mỏ khai thác than hầm lò với công suất bao nhiêu thì được xếp vào công trình cấp I?',
    options: [
  ...
  {
    question: 'Các mỏ khai thác quặng hầm lò với công suất bao nhiêu thì được xếp vào công trình cấp I?',
    options: [
  ...
  {
    question: 'Dự án đầu tư xây dựng mỏ Vật liệu xây dựng nhóm B sử dụng vốn đầu tư công, có công trình cấp cao nhất là cấp I do Chủ tịch UBND cấp tỉnh quyết định đầu tư thì phải trình cơ quan nào thẩm định thiết kế xây dựng triển khai sau thiết kế cơ sở?',
    options: [
  ...
  {
    question: 'Dự án đầu tư xây dựng mỏ khoáng sản kim loại nhóm A sử dụng đầu tư công, có công trình cấp cao nhất là cấp II, phải trình cơ quan nào thẩm định thiết kế xây dựng triển khai sau thiết kế cơ sở?',
    options: [
      'a. Cơ quan chuyên môn về xây dựng của Bộ Công thương.',
      'b. Sở Xây dựng.',
  ...
  {
    question: 'Dự án đầu tư xây dựng mỏ khoáng sản kim loại nhóm B sử dụng đầu tư công, có công trình cấp cao nhất là cấp II, phải trình cơ quan nào thẩm định thiết kế xây dựng triển khai sau thiết kế cơ sở?',
    options: [
      'a. Cơ quan chuyên môn về xây dựng của Bộ Công thương.',
      'b. Sở Công thương.',
      'c. Sở Kế hoạch và đầu tư.',
  ...
  {
    question: 'Dự án đầu tư xây dựng mỏ Vật liệu xây dựng nhóm A sử dụng đầu tư công, có công trình cấp cao nhất là cấp II, phải trình cơ quan nào thẩm định thiết kế xây dựng triển khai sau thiết kế cơ sở?',
    options: [
      'a. Cơ quan chuyên môn về xây dựng của Bộ Xây dựng.',
      'b. Sở Công thương.',
      'c. Sở Kế hoạch và đầu tư.',
  ...
  {
    question: 'Dự án đầu tư xây dựng mỏ Vật liệu xây dựng nhóm C sử dụng đầu tư công, công trình nằm trong ranh giới hành chính 2 tỉnh trở lên, phải trình cơ quan nào thẩm định thiết kế xây dựng triển khai sau thiết kế cơ sở?',
    options: [
      'a. Cơ quan chuyên môn về xây dựng của Bộ Xây dựng.',
      'b. Sở Xây dựng.',
      'c. Sở Kế hoạch và đầu tư.',
  ...
  {
    question: 'Khoảng cách giữa hai tim hầm đơn song song được xác định theo công thức\nKhoảng cách nhằm này đáp ứng yêu cầu gì sau đây ?',
    options: [
