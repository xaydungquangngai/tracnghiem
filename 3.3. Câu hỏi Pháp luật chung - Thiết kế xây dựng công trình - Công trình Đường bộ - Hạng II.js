const questions = [
  ...
  {
    question: 'Đối với các gói thầu sử dụng vốn đầu tư công, nhà thầu chính có quyền giao\n100% công việc của hợp đồng đã ký kết với bên giao thầu cho nhà thầu phụ không?',
    options: [
      'a. Có',
      'b. Không',
