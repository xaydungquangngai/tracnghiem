const questions = [
  {
    question: 'Bán kính đường cong tối thiểu trường hợp khó khăn do địa hình và các yếu tố khác trong tiêu chuẩn đường sắt đô thị bằng bao nhiêu?',
    options: [
      'a. R≥ 150m',
      'b. R≥ 155m',
      'c. R≥ 160m',
  ...
  {
    question: 'Đường sắt cấp II khổ 1000mm quy định khoảng cách giữa hai tim đường chính trên đường thẳng là bao nhiêu?',
    options: [
      'a. 3.8m',
      'b. 4.0m',
      'c. 4.1m',
  ...
  {
    question: 'Đường sắt tốc cao tốc độ thiết kế nằm trong khoảng ≥200km/h đến ≤250km/h khoảng cách giữa hai tim đường chính tuyến liền kề trên đường thẳng bằng bao nhiêu?',
    options: [
      'a. ≥4.40m',
      'b. ≥4.50m',
      'c. ≥4.60m',
  ...
  {
    question: 'Bán kính đường cong nằm tối thiểu của đường sắt cấp II - khổ 1435mm bằng bao nhiêu?',
    options: [
      'a. R≥ 1600m',
      'b. R≥ 1800m',
      'c. R≥ 2000m',
  ...
  {
    question: 'Trong trường hợp khó khăn độ dốc hạn chế của tuyến đường sắt cấp II - khổ 1435mm bằng bao nhiêu sử dụng sức kéo điện?',
    options: [
      'a. ip≤9‰',
      'b. ip≤10‰',
      'c. ip≤11‰',
  ...
  {
    question: 'Khổ giới hạn tiếp giáp kiến trúc trên đường cong trong hầm đường sắt được nới rộng về phía nào?',
    options: [
  ...
  {
    question: 'Ga đường sắt được phân thành các cấp kỹ thuật nào?',
    options: [
      'a. Ga cấp I',
      'b. Ga cấp II',
      'c. Ga cấp III',
  ...
  {
    question: 'Trường hợp nào độ dốc dọc trong ga được phép thiết kế với độ dốc lớn hơn\n2,5‰?',
    options: [
      'a. Ở vùng đồng bằng',
      'b. Ở vùng núi',
  ...
  {
    question: 'Đối với đường sắt làm mới hoặc cải tạo, sai lệch cho phép về độ cao mặt ray so với tiêu chuẩn quy định là bao nhiêu đối với khổ đường 1000 mm và 1435\nmm?',
    options: [
