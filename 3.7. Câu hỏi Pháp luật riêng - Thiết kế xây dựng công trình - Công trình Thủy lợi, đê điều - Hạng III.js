const questions = [
  {
    question: 'Hoạt động trong phạm vi bảo vệ công trình thủy lợi sau đây phải được cơ quan có thẩm quyền cấp giấy phép',
    options: [
      'a. Khoan, đào khảo sát địa chất.',
      'b. Thực hiện các dự án bảo trì, sửa chữa, nâng cấp, hiện đại hóa hoặc bổ sung hạng mục vào công trình thủy lợi hiện có.',
      'c. Đối với công trình thủy lợi đang khai thác, tổ chức, cá nhân sau đây có trách nhiệm cắm mốc chỉ giới phạm vi bảo vệ công trình thủy lợi',
      'd. Tổ chức, cá nhân khai thác công trình thủy lợi.',
    ],
    correct: 0
  },
  {
    question: 'Đối với công trình thủy lợi đang khai thác, tổ chức, cá nhân sau đây có trách nhiệm cắm mốc chỉ giới phạm vi bảo vệ công trình thủy lợi',
    options: [
      'a. Tổ chức, cá nhân khai thác công trình thủy lợi.',
      'b. Tổ chức, cá nhân quản lý công trình thủy lợi. Đối với công trình thủy lợi xây dựng mới việc cắm mốc chỉ giới phạm vi bảo vệ công trình thủy lợi thuộc trách nhiệm của',
      'a. Chủ đầu tư',
    ],
    correct: 0
  },
  {
    question: 'Đối với công trình thủy lợi xây dựng mới việc cắm mốc chỉ giới phạm vi bảo vệ công trình thủy lợi thuộc trách nhiệm của',
    options: [
      'a. Chủ đầu tư',
      'b. Tổ chức, cá nhân quản lý, khai thác công trình thủy lợi Đối với các dự án bảo trì, sửa chữa, nâng cấp, hiện đại hóa hoặc bổ sung hạng mục vào công trình thủy lợi hiện có do chủ sở hữu công trình thủy lợi quyết định chủ trương đầu tư thì không cần cơ quan có thẩm quyền cấp giấy phép hoạt động trong phạm vi bảo vệ công trình thủy lợi',
      'a. Đúng',
    ],
    correct: 0
  },
  {
    question: 'Đối với các dự án bảo trì, sửa chữa, nâng cấp, hiện đại hóa hoặc bổ sung hạng mục vào công trình thủy lợi hiện có do chủ sở hữu công trình thủy lợi quyết định chủ trương đầu tư thì không cần cơ quan có thẩm quyền cấp giấy phép hoạt động trong phạm vi bảo vệ công trình thủy lợi',
    options: [
      'a. Đúng',
      'b. Sai Yêu cầu về năng lực tối thiểu đối với tổ chức, cá nhân khai thác trạm bơm điện cố định có loại máy bơm công suất từ 11.000 m3/h trở lên: phải có ít nhất 02 kỹ sư chuyên ngành thủy lợi và 01 kỹ sư chuyên ngành cơ điện có thâm niên quản lý, vận hành từ 03 năm trở lên',
      'a. Đúng',
    ],
    correct: 0
  },
  {
    question: 'Yêu cầu về năng lực tối thiểu đối với tổ chức, cá nhân khai thác trạm bơm điện cố định có loại máy bơm công suất từ 11.000 m3/h trở lên: phải có ít nhất 02 kỹ sư chuyên ngành thủy lợi và 01 kỹ sư chuyên ngành cơ điện có thâm niên quản lý, vận hành từ 03 năm trở lên',
    options: [
      'a. Đúng',
      'b. Sai Trạm bơm điện có loại máy bơm công suất từ 8.000 m3/h đến dưới 11.000 m3/h: phải có ít nhất 01 kỹ sư chuyên ngành thủy lợi hoặc cơ điện có thâm niên quản lý, vận hành từ 03 năm trở lên',
      'a. Đúng',
    ],
    correct: 1
  },
  {
    question: 'Trạm bơm điện có loại máy bơm công suất từ 8.000 m3/h đến dưới 11.000 m3/h: phải có ít nhất 01 kỹ sư chuyên ngành thủy lợi hoặc cơ điện có thâm niên quản lý, vận hành từ 03 năm trở lên',
    options: [
      'a. Đúng',
      'b. Sai Trạm bơm điện có loại máy bơm công suất từ 4.000 m3/h đến dưới 8.000 m3/h: phải có ít nhất 01 kỹ sư chuyên ngành thủy lợi hoặc cơ điện có thâm niên quản lý, vận hành từ 01 năm trở lên',
      'a. Đúng',
    ],
    correct: 1
  },
  {
    question: 'Trạm bơm điện có loại máy bơm công suất từ 4.000 m3/h đến dưới 8.000 m3/h: phải có ít nhất 01 kỹ sư chuyên ngành thủy lợi hoặc cơ điện có thâm niên quản lý, vận hành từ 01 năm trở lên',
    options: [
      'a. Đúng',
      'b. Sai Tổ chức, cá nhân khai thác công trình thủy lợi có trách nhiệm lập phương án bảo vệ công trình thủy lợi',
      'a. Đúng',
    ],
    correct: 0
  },
  {
    question: 'Tổ chức, cá nhân khai thác công trình thủy lợi có trách nhiệm lập phương án bảo vệ công trình thủy lợi',
    options: [
      'a. Đúng',
      'b. Sai',
    ],
