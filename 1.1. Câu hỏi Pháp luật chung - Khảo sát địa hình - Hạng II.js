const questions = [
  {
    question: 'Trong công tác khảo sát xây dựng, nhiệm vụ khảo sát xây dựng được lập phục vụ công tác nào sau đây?',
    options: [
  ...
  {
    question: 'Trong công tác khảo sát xây dựng, nhiệm vụ khảo sát xây dựng được sửa đổi, bổ sung trong các trường hợp nào sau đây?',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      'c. Tuân thủ cả phương án a và',
      'b. d. Không cần tuân thủ nội dung nào ở trên.',
    ],
    correct: 2
  },
  {
  ...
  {
    question: 'Trong công tác khảo sát xây dựng, chủ đầu tư không có quyền nào dưới đây?',
    options: [
