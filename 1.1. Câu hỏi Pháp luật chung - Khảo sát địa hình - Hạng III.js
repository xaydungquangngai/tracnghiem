const questions = [
  {
    question: 'Trong hoạt động xây dựng hiện nay có các loại hình khảo sát xây dựng nào?',
    options: [
      'a. Khảo sát địa hình.',
      'b. Khảo sát địa chất công trình.',
      'c. Khảo sát địa chất thủy văn.',
      'd. Bao gồm cả 3 loại hình nêu tại a, b và',
    ],
    correct: 3
  },
  {
    question: 'Trong công tác khảo sát xây dựng, nhà thầu khảo sát xây dựng có những trách nhiệm gì dưới đây?',
    options: [
      ...
      'c. Cả hai nội dung a và b nêu ở trên.',
      'd. Không cần nội dung nào ở trên.',
    ],
    correct: 2
  },
  {
    question: 'Đơn vị nào dưới đây có trách nhiệm tổ chức giám sát khảo sát xây dựng?',
    options: [
      'a. Chủ đầu tư.',
  ...
  {
    question: 'Đơn vị nào dưới đây có trách nhiệm lập phương án kỹ thuật trong quá trình khảo sát xây dựng?',
    options: [
      'a. Chủ đầu tư.',
      'b. Nhà thầu khảo sát kỹ thuật.',
      'c. Nhà thầu thiết kế xây dựng.',
  ...
  },
  {
    ...
    options: [
      ...
      'd. Tất cả các nội dung đã ghi ở trên.',
    ],
    correct: 3
  },
  {
    question: 'Các cá nhân có trình độ cao đẳng, trung cấp đã được cấp chứng chỉ hành nghề thiết kế, được chủ trì thiết kế công trình cấp mấy?',
    options: [
      'a. Cấp II trở xuống.',
      'b. Cấp III trở xuống.',
      'c. Cấp IV.',
  ...
  {
    question: 'Theo Điều 79 Luật Xây dựng 2014, trường hợp nào khi xây dựng nhà ở riêng lẻ, chủ nhà được tự tổ chức thiết kế xây dựng?',
    options: [
      'a. Nhà ở có tổng diện tích sàn xây dựng nhỏ hơn 250 m2.',
      'b. Nhà ở có chiều cao dưới 3 tầng.',
      'c. Nhà ở có chiều cao dưới 12 mét.',
  ...
  {
    question: 'Trong công tác khảo sát xây dựng, những nội dung nào sau đây thuộc nhiệm vụ khảo sát xây dựng?',
    options: [
