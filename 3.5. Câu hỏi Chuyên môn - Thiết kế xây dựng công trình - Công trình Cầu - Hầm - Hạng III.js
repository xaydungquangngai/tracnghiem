const questions = [
  ...
  {
    question: 'Hãy cho biết tỉ lệ tối ưu giữa chiều dài nhịp biên và chiều dài nhịp chính của cầu dầm liên tục thi công theo công nghệ đúc hẫng cân bằng?',
    options: [
      'a. 0,60',
      'b. 0,65',
      'c. 0,85',
  ...
  {
    question: 'Đối với móng trụ cầu có chiều rộng lớn hơn 30m khảo sát tối thiểu mấy lỗ khoan khảo sát ?',
    options: [
      'a. 1 lỗ',
      'b. 2 lỗ',
      'c. 3 lỗ',
  ...
  {
    question: 'Đối với kết cấu bê tông cốt thép chịu nén không có giằng chống bên, hiệu ứng độ mảnh có thể bỏ qua khi tỷ số độ mảnh nhỏ hơn bao nhiêu?',
    options: [
      'a. 20',
      'b. 22',
      'c. 24',
  ...
  {
    question: 'Kích thước và số lượng ống thoát nước cần đảm bảo không ngập qua một nửa chiều rộng của bất kỳ làn xe nào áp dụng đối với cầu tốc độ thiết kế nhỏ hơn bao nhiêu ?',
    options: [
      'a. 60 Km/h',
      'b. 75 Km/h',
      'd. 80 Km/h',
  ...
  {
    question: 'Đối với cọc khoan nhồi ngàm trong nền đá vôi có hang Karst thì ?',
    options: [
  ...
  {
    question: 'Hãy giải thích tại sao tỉ lệ giữa chiều dài nhịp biên và chiều dài nhịp chính trong cầu dầm liên tục thi công theo công nghệ đúc hẫng cân bằng lại không lấy theo tỉ lệ hợp lý đối với dầm liên tục là 0,8 ?',
    options: [
  ...
  {
    question: 'Hãy cho biết tỉ lệ giữa chiều dài nhịp biên và chiều dài nhịp chính của cầu dầm liên tục thi công theo công nghệ đúc hẫng cân bằng?',
    options: [
      'a. 0,80',
      'b. 0,75',
      'c. 0,70',
