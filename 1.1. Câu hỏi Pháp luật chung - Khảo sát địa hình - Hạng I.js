const questions = [
  ...
  {
    question: 'Dự án đầu tư xây dựng bệnh viện nhóm B sử dụng vốn đầu tư công, có công trình cấp cao nhất là cấp I do Chủ tịch UBND cấp tỉnh quyết định đầu tư thì phải trình cơ quan nào thẩm định thiết kế xây dựng triển khai sau thiết kế cơ sở?',
    options: [
  ...
  {
    question: 'Dự án đầu tư xây dựng bệnh viện nhóm A sử dụng đầu tư công, có công trình cấp cao nhất là cấp II do Chủ tịch UBND cấp tỉnh quyết định đầu tư thì phải trình cơ quan nào thẩm định thiết kế thiết kế xây dựng triển khai sau thiết kế cơ sở?',
    options: [
      'a. Cơ quan chuyên môn về xây dựng của Bộ Xây dựng.',
      'b. Sở Xây dựng.',
  ...
  {
    question: 'Trong công tác khảo sát xây dựng, chủ đầu tư không có trách nhiệm nào dưới đây?',
    options: [
  ...
  {
    question: 'Trong công tác khảo sát xây dựng, nhà thầu khảo sát có nghĩa vụ gì?',
    options: [
