const questions = [
  {
    question: 'Đối với đồng hồ đo nước sạch, chu kỳ kiểm định đồng hồ đo nước lạnh cơ khí là bao lâu?',
    options: [
      'a. 36 tháng',
      'b. 48 tháng',
      'c. 60 tháng',
  ...
  {
    question: 'Trách nhiệm phê duyệt kế hoạch và lộ trình thực hiện kế hoạch cấp nước an toàn',
    options: [
      'a. Sở Xây dựng',
  ...
  {
    question: 'Diện tích đất xây dựng nhà máy xử lý nước thải quy hoạch mới được xác định trên cơ sở công suất, công nghệ xử lý hoặc tính toán theo tiêu chuẩn được lựa chọn áp dụng nhưng phải đảm bảo không được vượt quá chỉ tiêu',
    options: [
      'a. 0,5 ha/1.000 m3/ngày',
      'b. 0,4 ha/1.000 m3/ngày',
      'c. 0,3 ha/1.000 m3/ngày',
      'd. 0,2 ha/1.000 m3/ngày',
    ],
    correct: 3
  },
  {
