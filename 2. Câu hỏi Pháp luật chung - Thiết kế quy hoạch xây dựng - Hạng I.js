const questions = [
  {
    question: 'Theo Luật Xây dựng, Điều kiện năng lực của tổ chức lập thiết kế quy hoạch xây dựng được quy định theo phương án nào dưới đây:',
    options: [
      'a. Có đủ điều kiện năng lực lập thiết kế quy hoạch xây dựng; Cá nhân đảm nhận chức danh chủ nhiệm, chủ trì thiết kế đồ án quy hoạch xây dựng phải có chứng chỉ hành nghề và năng lực phù hợp về quy hoạch xây dựng.',
      'b. Có đủ điều kiện năng lực lập thiết kế quy hoạch xây dựng; Cá nhân đảm nhận chức danh chủ nhiệm, chủ trì thiết kế đồ án quy hoạch xây dựng phải có chứng chỉ hành nghề và năng lực phù hợp.',
      'c. Có đủ điều kiện năng lực lập thiết kế quy hoạch xây dựng phù hợp; Cá nhân đảm nhận chức danh chủ nhiệm, chủ trì thiết kế đồ án quy hoạch xây dựng phải có chứng chỉ hành nghề và năng lực phù hợp với từng loại quy hoạch xây dựng.',
      'd. Cả 3 phương án trên đều sai',
    ],
    correct: 2
  },
  {
    question: 'Theo Luật Xây dựng,, Cá nhân được cấp chứng chỉ hành nghề hoạt động xây dựng phải đáp ứng các điều kiện thep phương án nào dưới đây:',
    options: [
  ...
  {
    question: 'Các cá nhân xét cấp chứng chỉ hành nghề thiết kế quy hoạch xây dựng có chuyên môn đào tạo phù hợp nào theo các phương án dưới đây:',
    options: [
  ...
  {
    question: 'Các cá nhân có chứng chỉ hành nghề thiết kế quy hoạch xây dựng hạng II được phép làm các nội dung nào theo các phương án dưới đây:',
    options: [
      'a. Được làm chủ nhiệm đồ án, chủ trì thiết kế quy hoạch xây dựng của tất cả các đồ án quy hoạch xây dựng thuộc thẩm quyền phê duyệt của Ủy ban nhân dân cấp tỉnh, Ủy ban nhân dân cấp huyện;',
      'b. Được làm chủ nhiệm đồ án, chủ trì thiết kế quy hoạch xây dựng lĩnh vực chuyên môn của tất cả các đồ án quy hoạch xây dựng thuộc thẩm quyền phê duyệt của Ủy ban nhân dân cấp huyện',
      'c. Được làm chủ nhiệm đồ án, chủ trì thiết kế quy hoạch xây dựng lĩnh vực chuyên môn của tất cả các đồ án quy hoạch xây dựng thuộc thẩm quyền phê duyệt của Ủy ban nhân dân cấp tỉnh.',
      'd. Được làm chủ nhiệm đồ án, chủ trì thiết kế quy hoạch xây dựng lĩnh vực chuyên môn của tất cả các đồ án quy hoạch xây dựng thuộc thẩm quyền phê duyệt của Ủy ban nhân dân các cấp từ cấp tỉnh đến cấp huyện.',
    ],
    correct: 3
  },
  {
    question: 'Các cá nhân có chứng chỉ hành nghề thiết kế quy hoạch xây dựng hạng I được phép làm các nội dung nào theo các phương án dưới đây:',
    options: [
      'a. Được làm chủ nhiệm đồ án, chủ trì thiết kế quy hoạch xây dựng tất cả các đồ án quy hoạch xây dựng.',
      'b. Được làm chủ nhiệm đồ án, chủ trì thiết kế quy hoạch xây dựng tất cả các đồ án quy hoạch xây dựng, trừ các đồ án thuộc thẩm quyền phê duyệt của Thủ tướng Chính phủ.',
      'c. Được làm chủ nhiệm đồ án, chủ trì thiết kế quy hoạch xây dựng lĩnh vực chuyên môn của tất cả các đồ án quy hoạch xây dựng.',
      'd. Cả 3 phương án trên đều sai.',
    ],
    correct: 2
  },
  {
    question: 'Cơ quan duy nhất có quyền lập pháp của nước CHXHCN Việt Nam là cơ quan nào?',
    options: [
      'a. Chính phủ.',
  ...
  {
    question: 'Cơ quan quản lý Nhà nước cao nhất của nước Việt Nam về xây dựng là cơ quan nào?',
    options: [
      'a. Bộ xây dựng.',
  ...
  {
    question: 'Luật xây dựng số 62/2020/QH14 của Quốc hội là văn bản gì?',
    options: [
  ...
  {
    question: 'Theo pháp luật Việt Nam thì đối tượng áp dụng của số 62/2020/QH14 của Quốc hội được quy định như thế nào?',
    options: [
  ...
  {
    question: 'Pháp lệnh do cơ quan nào ban hành?',
    options: [
      'a. Chính phủ',
      'b. Quốc hội',
  ...
  {
    question: 'Tại Việt Nam Cơ quan quản lý nhà nước về xây dựng gồm:',
    options: [
  ...
  {
    question: 'Cơ quan chuyên môn quản lý nhà nước về xây dựng tại địa phương là cơ quan nào?',
    options: [
  ...
  {
    question: 'Theo quy định của pháp luật xây dựng Việt Nam, cơ quan quản lý Nhà nước cao nhất của nước Việt Nam về xây dựng là cơ quan nào?',
    options: [
      'a. Bộ xây dựng.',
      'b. Văn phòng chính phủ.',
      'c. Chính phủ.',
  ...
  {
    question: 'Theo quy định của pháp luật xây dựng Việt Nam, cơ quan chuyên môn quản lý Nhà nước về xây dựng cao nhất tại Việt Nam là cơ quan nào?',
    options: [
      'a. Quốc hội',
      'b. Văn phòng chính phủ.',
      'c. Chính phủ',
  ...
  {
    question: 'Đối với công trình cấp II và cấp III, quy định về thời gian thẩm định thiết kế xây dựng triển khai sau thiết kế cơ sở của cơ quan chuyên môn về xây dựng tính từ ngày nhận đủ hồ sơ hợp lệ như thế nào là đúng sau đây ?',
    options: [
      'a. Không quá 40 ngày',
      'b. Không quá 30 ngày',
      'c. Không quá 25 ngày',
  ...
  {
    question: 'Đối với dự án sử dụng vốn đầu tư công, dự án sử dụng vốn nhà nước ngoài đầu tư công chỉ cần lập Báo cáo kinh tế - kỹ thuật, người quyết định đầu tư thẩm định những nội dung nào sau đây?',
    options: [
  ...
  {
    question: 'Theo quy định của pháp luật về xây dựng, đối với nguồn vốn khác, chủ đầu tư có thể áp dụng hình thức quản lý dự án nào sau đây?',
    options: [
  ...
  {
    question: 'Trường hợp thuê tư vấn quản lý dự án thì nhiệm vụ, quyền hạn của tư vấn\nQLDA do ai quyết định?',
    options: [
  ...
  {
    question: 'Theo quy định của Luật Xây dựng, công tác thẩm định là việc kiểm tra, đánh giá của ai?',
    options: [
  ...
  {
    question: 'Trong quá trình lập dự án đầu tư xây dựng, tổ chức tư vấn lập dự án có các nghĩa vụ gì?',
    options: [
  ...
  {
    question: 'Hội đồng thẩm định hoặc đơn vị được giao nhiệm vụ thẩm định dự án PPP thẩm định Báo cáo nghiên cứu khả thi dự án PPP theo quy định của pháp luật nào sau đây ?',
    options: [
  ...
  {
    question: 'Việc quyết định đầu tư xây dựng của người quyết định đầu tư được thể hiện tại quyết định phê duyệt dự án đầu tư xây dựng, không bao gồm nội dung nào sau đây ?',
    options: [
  ...
  {
    question: 'Cơ quan chuyên môn về xây dựng từ chối tiếp nhận hồ sơ trình thẩm định Báo cáo nghiên cứu khả thi đầu tư xây dựng trong trường hợp nào sau đây?',
    options: [
  ...
  {
    question: 'Trong trường hợp thuê tư vấn quản lý dự án, chủ đầu tư có trách nhiệm như thế nào là đúng sau đây ?',
    options: [
  ...
  {
    question: 'Theo định nghĩa trong Luật Quy hoạch đô thị và nông thôn, nếu một khu vực không đạt các điều kiện về mật độ dân cư cao và không có vai trò thúc đẩy phát triển kinh tế - xã hội của quốc gia hoặc vùng lãnh thổ, khu vực đó có thể được xếp vào loại nào?',
    options: [
      'a. Đô thị loại đặc biệt',
      'b. Khu vực nông thôn hoặc khu chức năng đặc thù',
      'c. Đô thị loại IV',
      'd. Đô thị mới',
    ],
    correct: 1
  ...
  {
    question: 'Theo định nghĩa, yếu tố nào sau đây KHÔNG phải là yếu tố hình thành khu dân cư nông thôn?',
    options: [
      'a. Điều kiện tự nhiên',
      'b. Điều kiện kinh tế - xã hội',
      'c. Điều kiện hạ tầng kỹ thuật',
      'd. Điều kiện phát triển công nghiệp nặng',
    ],
    correct: 3
  },
  {
    question: 'Theo Luật, không gian dưới mặt đất trong không gian đô thị, nông thôn có thể bao gồm các nội dung nào sau đây?',
    options: [
      'a. Các công trình ngầm như bãi đỗ xe, hệ thống cống thoát nước, đường ngầm',
      'b. Hệ thống thoát nước thải và các khu bảo tồn thiên nhiên',
      'c. Chỉ bao gồm các công trình hạ tầng kỹ thuật',
      'd. Không gian dưới mặt đất không thuộc phạm vi quy hoạch',
    ],
    correct: 0
  },
  {
    question: 'Chỉ tiêu kinh tế - kỹ thuật được sử dụng trong quy hoạch với vai trò nào?',
    options: [
      'a. Là cơ sở để đề xuất các phương án, giải pháp quy hoạch',
      'b. Là mục tiêu cuối cùng của quy hoạch đô thị và nông thôn',
      'c. Là tiêu chí đánh giá hiệu quả kinh tế của các dự án công nghiệp',
      'd. Là chỉ tiêu tập trung cho phát triển kinh tế vùng đô thị',
    ],
    correct: 0
  },
];
