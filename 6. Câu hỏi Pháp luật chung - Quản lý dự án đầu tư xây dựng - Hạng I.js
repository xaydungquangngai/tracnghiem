const questions = [
  ...
  {
    question: 'Việc phân loại công trình xây dựng theo quy định của pháp luật xây dựng trên cơ sở tiêu chí nào?',
    options: [
  ...
  {
    question: 'Dự án đầu tư xây dựng sử dụng vốn đầu tư công, vốn nhà nước ngoài đầu tư công được điều chỉnh dự án trong trường hợp nào sau đây?',
    options: [
      'a. Khi qui hoạch xây dựng thay đổi, có ảnh hưởng trực tiếp đến dự án.',
      'b. Khi chỉ số giá xây dựng do Bộ Xây dựng, Ủy ban nhân dân cấp tỉnh công bố trong thời gian thực hiện dự án lớn hơn chỉ số giá xây dựng được sử dụng để tính dự phòng trượt giá trong tổng mức đầu tư dự án được duyệt.',
      'c. Do ảnh hưởng của thiên tai, sự cố môi trường, địch họa, hỏa hoạn và các yếu tố bất khả kháng khác.',
      'd. Câu a, b và',
    ],
    correct: 3
  },
  {
    question: 'Loại hình đầu tư nào sau đây thuộc lĩnh vực đầu tư công:',
    options: [
      'a. Đầu tư chương trình, dự án kết cấu hạ tầng kinh tế - xã hội; đầu tư phục vụ hoạt động của cơ quan nhà nước, đơn vị sự nghiệp, tổ chức chính trị, tổ chức chính trị - xã hội.',
      'b. Đầu tư và hỗ trợ hoạt động cung cấp sản phẩm, dịch vụ công ích;',
      'c. Đầu tư của Nhà nước tham gia thực hiện dự án theo hình thức đối tác công tư.',
      'd. Câu a, b và',
    ],
    correct: 3
  },
  ...
  {
    question: 'Việc áp dụng Tiêu chuẩn kỹ thuật trong hoạt động đầu tư xây dựng được quy định như thế nào?',
    options: [
  ...
  {
    question: 'Những loại tiêu chuẩn nào sau đây bắt buộc áp dụng trong hoạt động đầu tư xây dựng?',
    options: [
      'a. TCVN',
  ...
  {
    question: 'Đâu là quyền của Chủ đầu tư trong việc thi công xây dựng công trình',
    options: [
      ...
      'b. Tổ chức giám sát và quản lý chất lượng trong thi công xây dựng phù hợp với hình thức quản lý dự án, hợp đồng xây dựng',
      'c. Lựa chọn nhà thầu có đủ điều kiện năng lực hoạt động thi công xây dựng phù hợp với loại, cấp công trình và công việc thi công xây dựng',
      'd. Cả a, b và c',
    ],
    correct: 0
  },
  {
    question: 'Trường hợp Nhà thầu A liên danh với nhà thầu B cùng thi công xây dựng 01 công trình, trong đó theo thỏa thuận liên danh, Nhà thầu A là thành viên đứng đầu liên danh. Vậy những người nào của Liên danh nhà thầu nêu trên tham gia và ký biên bản nghiệm thu hoàn thành hạng mục công trình, công trình xây dựng?',
    options: [
      'a. Người đại diện theo pháp luật, chỉ huy trưởng hoặc giám đốc dự án của Nhà thầu A;',
      'b. Người đại diện theo pháp luật, chỉ huy trưởng hoặc giám đốc dự án của Nhà thầu B;',
      'c. Người đại diện theo pháp luật của Nhà thầu A, chỉ huy trưởng hoặc giám đốc dự án của Nhà thầu B;',
      'd. Gồm đáp án a và đáp án b',
    ],
    correct: 3
  },
  {
    question: 'Công trình thuộc dự án bệnh viện đa khoa trung ương có quy mô 300 giường bệnh, được xác định là cấp nào?',
    options: [
      'a. Cấp đặc biệt',
      'b. Cấp I',
      'c. Cấp II',
  ...
  {
    question: 'Thẩm quyền chủ trì tổ chức giám định nguyên nhân sự cố công trình xây dựng thuộc:',
    options: [
  ...
  {
    question: 'Ai quyết định việc bàn giao toàn bộ hoặc một phần mặt bằng xây dựng để thi công xây dựng công trình?',
    options: [
  ...
  {
    question: 'Chủ đầu tư có nghĩa vụ gì trong quá trình thi công xây dựng công trình?',
    options: [
