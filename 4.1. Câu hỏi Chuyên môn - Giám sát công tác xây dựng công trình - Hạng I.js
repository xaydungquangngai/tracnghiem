const questions = [
  {
    question: 'Sai lệch cho phép của kết cấu bê tông cốt thép toàn khối thi công bằng ván khuôn trượt hoặc ván khuôn leo là:',
    options: [
      'a. 80 mm.',
      'b. 100 mm.',
      'c. 120 mm.',
      'd. 1/500 chiều cao công trình nhưng không vượt quá 100mm.',
    ],
    correct: 3
  },
  {
    question: 'Hồ sơ nghiệm thu kết cấu bê tông lắp ghép bao gồm:',
    options: [
      'a. Chứng chỉ xuất xưởng của các cấu kiện đúc sẵn, Các văn bản xác định chất lượng, nguồn gốc xuất xứ các vật liệu xây dựng, Các chứng chỉ kiểm tra chất lượng vật liệu đầu vào. Kết quả thí nghiệm chất lượng mối hàn và bê tông chèn mối nối; Biên bản liệt kê chứng chỉ, trình độ tay nghề của công nhân tham gia lắp ghép.',
      'b. Bản vẽ hoàn công lắp cấu kiện, trong đó ghi rõ sai lệch thực tế so với thiết kế. Biên bản hoặc bản vẽ thay đổi thiết kế; Sơ đồ kiểm tra trắc đạc công trình; Biên bản nghiệm thu công tác khuất; Nhật ký thi công công trình (Những công việc quan trọng được ghi nhật ký theo mẫu biểu riêng);',
      'c. Cả a, b và hồ sơ thiết kế bản vẽ thi công, chỉ dẫn kỹ thuật;',
      'd. Cả a và',
    ],
    correct: 2
  },
  {
    question: 'Nghiệm thu công tác thi công cọc khoan nhồi được tiến hành dựa trên cơ sở:',
    options: [
      'a. Hồ sơ thiết kế được duyệt. Hồ sơ hoàn công cọc có thuyết minh sai lệch theo mặt bằng và chiều sâu cùng các cọc bổ sung và các thay đổi thiết kế đã được chấp thuận.',
      'b. Kết quả kiểm định chất lượng vật liệu, chứng chỉ xuất xưởng của cốt thép và các loại vật liệu chế tạo trong nhà máy; Kết quả thí nghiệm mẫu bê tông; Các kết quả thí nghiệm kiểm tra độ toàn khối của cọc (siêu âm, thí nghiệm biến dạng nhỏ (PIT)...) theo quy định của Thiết kế; Các kết quả thí nghiệm kiểm tra sức chịu tải của cọc. Biên bản nghiệm thu trắc đạc định vị trục móng cọc, Hồ sơ nghiệm thu từng cọc.',
      'c. Cả a và',
      'b. d. Cả a,b và yêu cầu kỹ thuật (nếu có) được các bên tham gia nghiệm thu chấp thuận.',
    ],
    correct: 3
  },
  {
    question: 'Độ lệch so với vị trí thiết kế của trục các cọc tròn rỗng bê tông cốt thép đường kính từ 0,5 m đến 0,8 m trên mặt bằng (cọc trục giữa. theo tiêu chuẩn TCVN 9394:2012 không được vượt quá trị số:',
    options: [
      'a. 15 cm.',
      'b. 8 cm.',
      'c. 10 cm;',
  ...
  {
    question: 'Trong quá trình giám sát thi công kết cấu bê tông cốt thép đến tầng 25 của công trình cấp I, thì phát hiện nhiều các vết nứt chiều dài khoảng 1m, rộng 0,8-1mm tại dầm sàn các tầng hầm và tầng 1 đến tầng 2, giám sát trưởng phải làm như thế nào là đúng:',
    options: [
      'a. Tiếp tục quan trắc theo dõi vết nứt, yêu cầu nhà thầu thi công có biện pháp xử lý ngay.',
      'b. Yêu cầu nhà thầu đề xuất biện pháp xử lý để tư vấn giám sát kiểm tra chấp thuận.',
      'c. Tiếp tục quan trắc theo dõi vết nứt, báo cáo chủ đầu tư, liên hệ với nhà thầu tư vấn biện pháp xử lý khắc phục.',
      'd. Tiếp tục quan trắc theo dõi vết nứt, báo cáo chủ đầu tư, đề xuất tư vấn kiểm định, khảo sát đánh giá chất lượng kết cấu hiện trạng và biện pháp xử lý khắc phục.',
    ],
    correct: 3
  },
  {
  ...
  {
    question: 'Kiểm tra giám sát việc ghi chép lực ép theo nhật ký ép cọc được tiến hành như sau:',
    options: [
  ...
  {
    question: 'Chỉ tiêu nào dưới đây không dùng để đánh chất lượng của nhựa đường đặc\xa0 60/70?',
    options: [
      'a. Độ kim lún ở 25oC',
  ...
  },
  {
    ...
    options: [
      'a. (1) Nạo vét, (2) San lấp bãi và xử lý nền (nếu có), (3) Đóng cọc; (4) Đổ đá mái dốcgầm bến, (5) Thi công kết cấu trên, (6) Thi công tường chắn hoặc kè bờ; (7) Thi công bãi sau bến và hệ thống kỹ thuật.',
  ...
  {
    question: 'Tiêu chuẩn kỹ thuật nghiệm thu công tác chèn tà vẹt đường sắt có mối nốitrên đường chính tuyến và đường đón gửi tàu phải đảm bảo những yêu cầunào?',
    options: [
  ...
  {
    question: 'Nội dung công tác nghiệm thu khe hở ray trên đường chính tuyến vàđường đón gửi tàu?',
    options: [
  ...
  },
  {
    ...
    options: [
      'a. Cỡ hạt 25mm - 50 mm chiếm tỷ lệ ≥ 90% khối lượng toàn bộ',
  ...
  {
    question: 'Nhà thầu dùng Giá lao cầu tự chế và Cần cẩu nổi tự chế trên hệ nổi để laocầu. Ai có quyền kiểm tra và cho phép sử dụng Giá lao cầu và Hệ cẩu nổinày:',
    options: [
      'a. Tư vấn giám sát',
  ...
  },
  {
    ...
    options: [
      'a. Không có ý kiến gì vì thiết bị đã được kiểm tra trước khi chấp thuận chon PTN hoạt động trong dự án.',
  ...
  {
    question: 'Khi kiểm tra xử lý độ ẩm của đất đắp cho phù hớp với độ ẩm thiết kế cần lấy mẫu ở vị trí nào?',
    options: [
  ...
  {
    question: 'Nếu thời gian tạm ngừng đổ bê tông vượt quá giới hạn quy định thì chophép xử lý bề mặt khi cường độ của lớp bê tông bên dưới đạt bằng baonhiêu?',
    options: [
      'a. 25 daN/cm2.',
      'b. 20 daN/cm2.',
      'c. 15 daN/cm2.',
  ...
  {
    question: 'Số lượng mẫu thí nghiệm dung trọng khô của đất sét khi thi công đắp đất\nchung quanh cống ngầm trong thân đập đất (đầm bằng máy đầm cóc. được quy định như thế nào?',
    options: [
  ...
  {
    question: 'Hàm lượng bùn, bụi, sét bột theo % khối lượng của mẫu cát để thi công kết cấu bê tông dưới nước cho phép như thé nào?',
    options: [
  ...
  {
    question: 'Khi đổ bê tông sử dụng thiết bị đầm là máy đầm dùi chấn động, độ dày lớnnhất cho phép của mỗi lớp hỗn hợp bê tông đổ xuống khoảnh đổ là baonhiêu?',
    options: [
