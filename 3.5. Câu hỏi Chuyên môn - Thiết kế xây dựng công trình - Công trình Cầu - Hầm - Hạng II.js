const questions = [
  {
    question: 'Hãy cho biết giới hạn chảy Fy tối thiểu của thép hợp kim thấp cường độ cao sử dụng cho dầm cầu',
    options: [
      'a. 190 Mpa',
      'b. 250 Mpa',
      'c. 345 Mpa',
  ...
  {
    question: 'Độ võng cho phép đối với cầu có tải trọng người đi bộ là bao nhiêu, (L chiều dài nhịp)?',
    options: [
      'a. L/300',
      'b. L/375',
      'c. L/800',
  ...
  {
    question: 'Tỷ lệ gia tăng lực xung kích IM đối với các TTGH (Trừ mỏi và nứt gãy và trừ mối nối bản mặt cầu) là bao nhiêu?',
    options: [
      'a. 15%',
      'b. 25%',
      'c. 33%',
  ...
  {
    question: 'Để tính tải trọng gió trong quá trình thi công, lắp ráp có thể nhân vận tốc gió cơ bản VB với hệ số bao nhiêu?',
    options: [
      'a. 0,5',
      'b. 0,75',
      'c. 0,85',
  ...
  {
    question: 'Hệ số điều chỉnh ứng sử R khi tính các liên kết giữa cột hay trụ với móng tại tải trọng động đất là bao nhiêu?',
    options: [
      'a. 0,8',
      'b. 1,0',
      'c. 1,5',
  ...
  {
    question: 'Để tính tải trọng gió trong quá trình thi công vận tốc gió Vb cho các vùng tính gió ở Việt Nam nhân với hệ số?',
    options: [
      'a. 0.65',
      'b. 0.75',
      'c. 0.8',
  ...
  {
    question: 'Mố trụ đặt trong phạm vi cách mép lòng đường bộ hay trong phạm vi đến tim đường sắt bao nhiêu mm thì phải tính lực va tĩnh tác động vào mố trụ?',
    options: [
      'a. 8000mm và 16000mm',
      'b. 9000mm và 15000mm',
  ...
  {
    question: 'Đối với vùng động đất 1 có hệ số gia tốc nền nhỏ hơn 0.025 và nền đất thuộc loại I hoặc loại II thì lực liên kết ngang thiết kế trong các chiều bị kềm giữ dịch chuyển không được lấy nhỏ hơn bao nhiêu lần phản lực thẳng đứng do tải trọng thường xuyên?',
    options: [
      'a. 0.1',
      'b. 0.15',
      'c. 0.2',
  ...
  {
    question: 'Hệ số tải trọng lớn nhất đối với tải trọng lớp phủ mặt cầu và các tiện ích (DW) tương ứng là bao nhiêu?',
    options: [
      'a. 1.25 và 0.9',
      'b. 1.5 và 0.65',
      'c. 1.35 và 0.9',
