const questions = [
  ...
  {
    question: 'Theo định nghĩa của Luật, đô thị KHÔNG có đặc điểm nào sau đây?',
    options: [
  ...
  {
    question: 'Khu dân cư nông thôn có đặc điểm nào dưới đây?',
    options: [
  ...
  {
    question: 'Không gian đô thị, nông thôn bao gồm các yếu tố nào sau đây?',
    options: [
  ...
  {
    question: 'Trong nội dung của chỉ tiêu kinh tế - kỹ thuật, yếu tố nào sau đây KHÔNG thuộc các chỉ tiêu quy hoạch?',
    options: [
      'a. Quy mô dân số',
