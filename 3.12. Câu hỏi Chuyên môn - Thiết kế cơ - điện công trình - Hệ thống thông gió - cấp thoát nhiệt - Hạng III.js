const questions = [
  ...
  {
    question: 'Đối với hệ thống thông gió tự nhiên và cơ khí, về mùa hè, nhiệt độ tính toán của không khí bên trong phòng không được vượt quá 3°C so với nhiệt độ nào sau đây?',
    options: [
  ...
  {
    question: 'Thông số tính toán của không khí trong phòng dùng để thiết kế điều hòa không khí về mùa hè có nhiệt độ từ 22 - 25(°C), độ ẩm tương đối từ 60 - 70 (%), vận tốc gió từ 1,2 -1,5 (m/s) tương ứng với trạng thái lao động nào dưới đây ?',
    options: [
