const questions = [
  ...
  {
    question: 'Đường sắt cấp III khổ 1000mm quy định khoảng cách giữa hai tim đường chính trên đường thẳng là bao nhiêu?',
    options: [
      'a. 3.8m',
      'b. 4.0m',
      'c. 4.4m',
  ...
  {
    question: 'Đường sắt tốc cao tốc độ thiết kế ≤350km/h trường hợp bình thường, kiến trúc tầng trên có đá ballast thì bán kính đường cong nằm nhỏ nhất bằng bao nhiêu?',
    options: [
      'a. R≥ 5000m',
      'b. R≥ 6000m',
      'c. R≥ 7000m',
  ...
  {
    question: 'Đường sắt tốc cao tốc độ thiết kế ≤300km/h khoảng cách giữa hai tim đường chính tuyến liền kề trên đường thẳng bằng bao nhiêu?',
    options: [
      'a. ≥4.70m',
      'b. ≥4.80m',
      'c. ≥5.00m',
  ...
  {
    question: 'Đối với đường sắt làm mới, cải tạo sửa chữa lớn, sai lệch khoảng cách 2 má ray trên đường thẳng cũng như trên đường cong phải đảm bảo như thế nào?',
    options: [
      'a. Không được lớn quá + 4mm và nhỏ quá -2mm',
      'b. Không được lớn quá + 5mm và nhỏ quá -2mm',
      'c. Không được lớn quá + 5mm và nhỏ quá -5mm',
      'd. Không được lớn quá + 10mm và nhỏ quá -5mm',
    ],
    correct: 0
  },
  {
