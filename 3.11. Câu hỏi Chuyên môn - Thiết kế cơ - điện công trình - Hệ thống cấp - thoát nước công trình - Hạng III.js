const questions = [
  ...
  {
    question: 'Khi thiết kế công trình thu nước sông của hệ thống cấp nước, mép dưới cửa thu nước phải đặt cao hơn đáy sông hồ tối thiểu bao nhiêu?',
    options: [
      'a. 0,5 m.',
      'b. 0.8 m.',
      'c. 1,0 m.',
  ...
  {
    question: 'Mực nước tính toán tối thiểu trong các ngăn thu nước phải xác định bằng tính toán thủy lực, ứng với các trường hợp nào sau đây:',
    options: [
  ...
  {
    question: 'Chức năng công trình điều hòa và làm chậm dòng chảy nước mưa?',
    options: [
  ...
  {
    question: 'Để đảm bảo độ tin cậy của hệ thống thoát nước, khi thiết kế phải tính đến?',
    options: [
  ...
  {
    question: 'Chu kỳ lặp lại trận mưa tính toán P (năm) phụ thuộc?',
    options: [
